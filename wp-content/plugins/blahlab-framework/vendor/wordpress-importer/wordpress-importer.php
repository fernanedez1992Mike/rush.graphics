...
require plugin_dir_path(__FILE__) . '../../vendor/wordpress-importer/parsers.php';
...
<form action="<?php echo admin_url( 'admin.php?import=wordpress&amp;step=2' ); ?>" method="post">
	...
	<input type="hidden" name="import_id" value="<?php echo blahlab_esc($this->id); ?>" />
...
<?php
	...
	function fetch_remote_file( $url, $post ) {
		...
		// BLAHLAB HACK, fix the deprecated warning
		$headers = blahlab_wpgethttp( $url, $upload['file'] );
...
function blahlab_wordpress_importer_init() {
...
add_action( 'admin_init', 'blahlab_wordpress_importer_init' );
