...
class WPAlchemy_MetaBox
{
	...
	function _foot()
	{
		...
		)
		{
			...
			(function($){ /* not using jQuery ondomready, code runs right away in footer */
				...
				var mb_id = '<?php echo blahlab_esc($this->id); ?>';
	...
	function _setup()
	{
		...
		$blahlab_framework_mb =& $this;
		$blahlab_framework_id = $id;
	...
	function the_id()
	{
		echo blahlab_esc($this->get_the_id());
	}
	...
	{
		echo blahlab_esc($this->get_the_value($n));
	}
	...
	{
		echo blahlab_esc($this->get_the_name($n));
	}
	...
	function the_index()
	{
		echo blahlab_esc($this->get_the_index());
	}
	...
	{
		echo blahlab_esc($this->get_the_checkbox_state($n, $v));
	}
	...
	{
		echo blahlab_esc($this->get_the_select_state($n, $v));
	}
	...
	{
		echo blahlab_esc($this->get_the_group_open($t));
	}
	...
	{
		echo blahlab_esc($this->get_the_group_close());
	}
