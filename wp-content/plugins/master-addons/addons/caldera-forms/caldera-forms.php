...
class JLTMA_Caldera_Forms extends Widget_Base
{
	...
	{
		return esc_html__('Caldera Forms', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_info_box',
			[
				'label' => esc_html__('Caldera Forms', JLTMA_TD),
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'4'         => __('Style Four', JLTMA_TD),
						'5'         => __('Style Five', JLTMA_TD),
						'clf-pro-1' => __('Style Five (Pro)', JLTMA_TD),
						'clf-pro-2' => __('Style Six (Pro)', JLTMA_TD),
						'clf-pro-3' => __('Style Seven (Pro)', JLTMA_TD),
						'clf-pro-4' => __('Style Eight (Pro)', JLTMA_TD),
						'clf-pro-5' => __('Style Nine (Pro)', JLTMA_TD),
						'clf-pro-6' => __('Style Ten (Pro)', JLTMA_TD),
						'clf-pro-7' => __('Style Eleven (Pro)', JLTMA_TD),
					],
					'description' => sprintf(
		...
		$this->add_control(
			...
			[
				'label'     => __('Error Fields', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'       => __('Input Border', JLTMA_TD),
				'placeholder' => '1px',
				'default'     => '1px',
...
Customization Options.</span>'
	...
	protected function render()
	{
		...
		if (!class_exists('Caldera_Forms')) {
			Master_Addons_Helper::jltma_elementor_plugin_missing_notice(array('plugin_name' => esc_html__('Caldera Forms', JLTMA_TD)));
			return;
		}
