...
class JLTMA_Gravity_Forms extends Widget_Base
{
	...
	{
		return esc_html__('Gravity Forms', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->start_controls_section(
				...
				[
					'label'                 => __('Gravity Forms', JLTMA_TD),
				]
			);
			...
			$this->add_control(
				'form_ajax',
				[
					'label'                 => __('Use Ajax', JLTMA_TD),
					'type'                  => Controls_Manager::SWITCHER,
					'description'           => __('Use ajax to submit the form', JLTMA_TD),
					'label_on'              => __('Yes', JLTMA_TD),
					'label_off'             => __('No', JLTMA_TD),
					'return_value'          => 'yes',
				]
			...
			$this->start_controls_section(
				'section_field_style',
				[
					'label'                 => __('Section Field', JLTMA_TD),
					'tab'                   => Controls_Manager::TAB_STYLE,
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label'                 => __('Border Height', JLTMA_TD),
					'type'                  => Controls_Manager::SLIDER,
					'default'               => [
						'size'  => 1,
					],
			...
			$this->add_control(
				'price_label_color',
				[
					'label'                 => __('Price Label Color', JLTMA_TD),
					'type'                  => Controls_Manager::COLOR,
					'default'               => '',
					'selectors'             => [
			...
			$this->start_controls_section(
				...
				[
					'label'                 => __('Progress Bar', JLTMA_TD),
					'tab'                   => Controls_Manager::TAB_STYLE,
				]
			);
			...
			$this->add_control(
				...
				[
					'label'                 => __('Error Border Color', JLTMA_TD),
					'type'                  => Controls_Manager::COLOR,
					'default'               => '',
					'selectors'             => [
			...
			$this->add_control(
				...
				[
					'label'                 => __('Error Field Background Color', JLTMA_TD),
					'type'                  => Controls_Manager::COLOR,
					'default'               => '',
					'selectors'             => [
			...
			$this->add_control(
				...
				[
					'label'                 => __('Error Field Label Color', JLTMA_TD),
					'type'                  => Controls_Manager::COLOR,
					'default'               => '',
					'selectors'             => [
			...
			$this->start_controls_section(
				'section_ty_style',
				[
					'label'                 => __('Thank You Message', JLTMA_TD),
					'tab'                   => Controls_Manager::TAB_STYLE,
				]
			);
	...
	protected function render()
	{
		...
		if (!class_exists('GFCommon')) {
			Master_Addons_Helper::jltma_elementor_plugin_missing_notice(array('plugin_name' => esc_html__('Gravity Form', JLTMA_TD)));
			return;
		}
...
<?php
				...
				esc_html__e('Please select a Contact Form!', JLTMA_TD);
			}
		}
	}
