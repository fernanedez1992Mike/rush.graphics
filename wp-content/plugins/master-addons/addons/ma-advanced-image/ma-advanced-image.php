...
class JLTMA_Advanced_Image extends Widget_Base
{
	...
	{
		return esc_html__('Advanced Image', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			array(
				'label'        => __('Display Hover Image', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__('Diplay Ribbon', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('On', JLTMA_TD),
				'label_off'    => esc_html__('Off', JLTMA_TD),
				'return_value' => 'yes',
				'default'      => 'no'
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__('Text', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__('Ribbon Style', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'simple',
				'options'     => array(
					'simple' => esc_html__('Simple', JLTMA_TD),
					'corner' => esc_html__('Corner', JLTMA_TD),
					'cross'  => esc_html__('Cross', JLTMA_TD)
				),
				'condition'   => array(
					'ma_el_adv_image_display_ribbon' => 'yes'
				)
		...
		$this->add_control(
			...
			array(
				'label'       => __('Ribbon Position', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'top-right',
				'options'     => array(
					'top-left'     => __('Top Left', JLTMA_TD),
					'top-right'    => __('Top Right', JLTMA_TD),
					'bottom-left'  => __('Bottom Left', JLTMA_TD),
					'bottom-right' => __('Bottom Right', JLTMA_TD)
				),
				'condition'   => array(
					'ma_el_adv_image_display_ribbon' => 'yes'
				)
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __('Ribbon Thickness', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'        => __('Open in lightbox', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('On', JLTMA_TD),
				'label_off'    => __('Off', JLTMA_TD),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'       => __('Iconic button', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'plus',
				'options'     => array(
					'none' => __('None', JLTMA_TD),
					'plus' => __('Plus', JLTMA_TD)
				),
				'condition'   => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => __('Image alignment in block.', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				'label'        => __('Preload image', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('On', JLTMA_TD),
				'label_off'    => __('Off', JLTMA_TD),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'        => __('While loading image display', JLTMA_TD),
				'label_block'  => true,
				'type'         => Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			array(
				'label'     => __('Placeholder color while loading image', JLTMA_TD),
		...
		$this->add_control(
			...
			array(
				...
				'description'  => __('Adds tilt effect to the image.', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('On', JLTMA_TD),
				'label_off'    => __('Off', JLTMA_TD),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'        => __('Colorized Shadow', JLTMA_TD),
				'description'  => __('Adds colorized shadow to the image. Note: This feature is not available when image hover is active.', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('On', JLTMA_TD),
				'label_off'    => __('Off', JLTMA_TD),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __('Vertical Move', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array('px', 'em', '%'),
				'range'      => array(
					'px' => array(
