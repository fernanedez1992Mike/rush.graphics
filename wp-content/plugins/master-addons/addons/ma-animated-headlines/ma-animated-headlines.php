...
class JLTMA_Animated_Headlines extends Widget_Base
{
	...
	{
		return esc_html__('Animated Headlines', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => false,
					'options'     => [
						'rotate-1'    => esc_html__('Rotate 1', JLTMA_TD),
						'rotate-2'    => esc_html__('Rotate 2', JLTMA_TD),
						'rotate-3'    => esc_html__('Rotate 3', JLTMA_TD),
						'type'        => esc_html__('Typing', JLTMA_TD),
						'loading-bar' => esc_html__('Loading Bar', JLTMA_TD),
						'slide'       => esc_html__('Slide', JLTMA_TD),
						'clip'        => esc_html__('Clip', JLTMA_TD),
						'zoom'        => esc_html__('Zoom', JLTMA_TD),
						'scale'       => esc_html__('Scale', JLTMA_TD),
						'push'        => esc_html__('Push', JLTMA_TD)
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'options'     => [
						...
						'rotate-3'         => esc_html__('Rotate 3', JLTMA_TD),
						'loading-bar'      => esc_html__('Loading Bar', JLTMA_TD),
						'ma-heading-pro-1' => esc_html__('Typing (Pro)', JLTMA_TD),
						'ma-heading-pro-2' => esc_html__('Slide (Pro)', JLTMA_TD),
						'ma-heading-pro-3' => esc_html__('Clip (Pro)', JLTMA_TD),
						'ma-heading-pro-4' => esc_html__('Zoom (Pro)', JLTMA_TD),
						'ma-heading-pro-5' => esc_html__('Scale (Pro)', JLTMA_TD),
						'ma-heading-pro-6' => esc_html__('Push (Pro)', JLTMA_TD)
					],
					'description' => sprintf(
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('First Heading', JLTMA_TD),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Master Addons', JLTMA_TD),
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'   => __('More Titles', JLTMA_TD),
				'type'    => Controls_Manager::TEXT,
				'default' => __('Minimal Template', JLTMA_TD),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					['ma_el_headlines_second_heading' => esc_html__('Ultimate Addons', JLTMA_TD)],
					['ma_el_headlines_second_heading' => esc_html__('Elementor Widgets', JLTMA_TD)],
					['ma_el_headlines_second_heading' => esc_html__('Unique Design', JLTMA_TD)],
					['ma_el_headlines_second_heading' => esc_html__('Unlimited Variations', JLTMA_TD)],
					['ma_el_headlines_second_heading' => esc_html__('Unlimited Possibilities', JLTMA_TD)],
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Animation Settings', JLTMA_TD),
		...
		$this->add_control(
			'anim_delay',
			[
				'label'              => esc_html__('Animation Delay', JLTMA_TD),
		...
		$this->add_control(
			'letters_anim_delay',
			[
				'label'              => esc_html__('Letters Delay', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 50,
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			'type_anim_delay',
			[
				'label'              => esc_html__('Type Letters Delay', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 150,
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Selection Duration', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 500,
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			'clip_reveal_delay',
			[
				'label'              => esc_html__('Reveal Duration', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 600,
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			'clip_anim_duration',
			[
				'label'              => esc_html__('Reveal Animation Delay', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 1500,
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/animated-headline/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/animated-headline-elementor/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=09QIUPdUQnM" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Second Heading', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
