...
class JLTMA_Blockquote extends Widget_Base
{
	...
	{
		return esc_html__('Blockquote', JLTMA_TD);
	}
	...
	protected function jltma_blockquote_content_section()
	{
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Blockquote', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('Architecture should speak of its time and place, but yearn for timelessness', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Quote Author', JLTMA_TD),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Scott Adams', JLTMA_TD),
			]
		);
	...
	protected function jltma_quote_text_section()
	{
		...
		$this->add_responsive_control(
			'text_align',
			[
				'label'       => __('Text Alignment', JLTMA_TD),
	...
	protected function jltma_quote_symbol_section()
	{
		...
		$this->start_controls_section(
			...
			[
				'label'     => __('Quote Symbol', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			'quote_symbol',
			[
				'label'        => __('Show quote symbol', JLTMA_TD),
		...
		$this->add_control(
			'quote_symbol_color',
			[
				'label'     => __('Quote symbol color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/blockquote-element/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/blockquote-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=sSCULgPFSHU" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
