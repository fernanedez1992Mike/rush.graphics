...
class JLTMA_Blog extends Widget_Base
{
	...
	{
		return esc_html__('Blog Posts', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		*/
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Display Options', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			'ma_el_blog_skin',
			[
				'label'         => __('Blog Layout', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'classic'       => __('Classic', JLTMA_TD),
					'cards'         => __('Cards', JLTMA_TD)
				],
				'default'       => 'classic',
				'label_block'   => true
			]
		...
		$this->add_control(
			...
			[
				'label'         => __('Blog Type', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'grid'          => __('Grid Layout', JLTMA_TD),
					'list'          => __('List Layout', JLTMA_TD),
					'masonry'       => __('Masonry Layout', JLTMA_TD),
				],
		...
		$this->add_control(
			...
			[
				'label'         => __('Cards Layout', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'default'                => __('Default', JLTMA_TD),
					'absolute_content'       => __('Content Overlap', JLTMA_TD),
					'absolute_content_two'   => __('Top Left Meta', JLTMA_TD),
					'cards_right'            => __('Right Align Cards', JLTMA_TD),
					'cards_center'           => __('Center Align Cards', JLTMA_TD),
					'gradient_bg'            => __('Center Align Gradient BG', JLTMA_TD),
					'full_banner'            => __('Banner Card', JLTMA_TD)
				],
				'default'       => 'default',
				'label_block'   => true,
				'condition'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('List Layout Type', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'classic'               => __('List Classic', JLTMA_TD),
					'meta_bg'               => __('List Meta Background', JLTMA_TD),
					'button_right'          => __('List Button Right', JLTMA_TD),
					'content_overlap'       => __('List Content Overlap', JLTMA_TD),
					'thumbnail_hover'       => __('List Thumbnail Hover', JLTMA_TD),
					'thumbnail_hover_nav'   => __('List Blur Content', JLTMA_TD),
					'thumbnail_bg'          => __('List Thumbnail Background', JLTMA_TD),
		...
		$this->add_control(
			'ma_el_blog_order',
			[
				'label'         => __('Post Order', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'label_block'   => true,
				'options'       => [
					'asc'           => __('Ascending', JLTMA_TD),
					'desc'          => __('Descending', JLTMA_TD)
				],
				'default'       => 'desc'
			]
		);
		...
		$this->add_responsive_control(
			'ma_el_blog_cols',
			[
				'label'         => __('Number of Columns', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'100%'          => __('1 Column', JLTMA_TD),
					'50%'           => __('2 Columns', JLTMA_TD),
					'33.33%'        => __('3 Columns', JLTMA_TD),
					'25%'           => __('4 Columns', JLTMA_TD)
				],
				'default'       => '25%',
		...
		$this->add_control(
			...
			[
				'label'         => __('Post Meta Separator', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => __('Select Taxonomy', JLTMA_TD),
				'type' => Controls_Manager::SELECT2,
				'options' => '',
				'condition' => [
					'post_type!' => '',
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Rows Spacing', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Columns Spacing', JLTMA_TD),
				'type'          => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', "em"],
				'range'         => [
					'px'    => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Content Alignment', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'         => __('Total Number of Posts', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'         => __('Posts Per Page', JLTMA_TD),
				'type'          => Controls_Manager::NUMBER,
				'min'			=> 1,
				'default'       => '4'
			]
		...
		$this->add_control(
			...
			[
				'label'         => __('Pagination', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'description'   => __('Pagination is the process of dividing the posts into discrete pages', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'			=> __('Next Page Text', JLTMA_TD),
				'type'			=> Controls_Manager::TEXT,
				'default'       => __('Next Post', JLTMA_TD),
				'condition'     => [
		...
		$this->add_control(
			...
			[
				'label'			=> __('Previous Page Text', JLTMA_TD),
				'type'			=> Controls_Manager::TEXT,
				'default'       => __('Previous Post', JLTMA_TD),
				'condition'     => [
					'ma_el_blog_pagination'      => 'yes',
				]
			]
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Pagination Alignment', JLTMA_TD),
				'type'          => Controls_Manager::CHOOSE,
				'options'       => [
					'left'      => [
						'title' => __('Left', JLTMA_TD),
		...
		$this->add_control(
			'ma_el_blog_carousel',
			[
				'label'         => __('Enable Carousel?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Carousel Settings', JLTMA_TD),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Thumbnail Settings', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'          => Controls_Manager::SWITCHER,
				'description'   => __('Show or Hide Thumbnail', JLTMA_TD),
				'default'       => 'yes',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Thumbnail Fit', JLTMA_TD),
				'description'   => __('You need to set Height for work Thumbnail Fit ', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'landscape'     => __('Landscape', JLTMA_TD),
					'square'        => __('Square', JLTMA_TD),
					'cover'         => __('Cover', JLTMA_TD),
					'fill'          => __('Fill', JLTMA_TD),
					'contain'       => __('Contain', JLTMA_TD),
				],
				'default'       => 'cover',
				'selectors'     => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Thumbnail Min Height', JLTMA_TD),
				'type'          => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', "em"],
				'range'         => [
					'px'    => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Thumbnail Max Height', JLTMA_TD),
				'type'          => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', "em"],
				'range'         => [
					'px'    => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Thumbnail Position', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'description'   => __('Thumbnail Image Position', JLTMA_TD),
				'options'       => [
					'default'   		=> __('Default', JLTMA_TD),
					'left'      		=> __('Left', JLTMA_TD),
					'thumb_top'     	=> __('Top Thumb, Bottom Title', JLTMA_TD),
					'thumb_bottom'     	=> __('Bottom Thumb, Title Top', JLTMA_TD),
				],
				'default'       => 'default',
				'label_block'   => true,
				'condition'     => [
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => __('Hover Animation', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'         => __('Color Effect', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'description'   => __('Choose an overlay color effect', JLTMA_TD),
				'options'       => [
					'none'                   => __('No Effect', JLTMA_TD),
					'zoom_in_one'            => __('Zoom In #1', JLTMA_TD),
					'zoom_in_two'            => __('Zoom In #2', JLTMA_TD),
					'zoom_out_one'           => __('Zoom Out #1', JLTMA_TD),
					'zoom_out_two'           => __('Zoom Out #2', JLTMA_TD),
					'rotate_zoomout'         => __('Rotate + Zoom Out', JLTMA_TD),
					'slide'                  => __('Slide', JLTMA_TD),
					'grayscale'              => __('Gray Scale', JLTMA_TD),
					'blur'                   => __('Blur', JLTMA_TD),
					'sepia'                  => __('Sepia', JLTMA_TD),
					'blur_sepia'             => __('Blur + Sepia', JLTMA_TD),
					'blur_grayscale'         => __('Blur + Gray Scale', JLTMA_TD),
					'opacity_one'            => __('Opacity #1', JLTMA_TD),
					'opacity_two'            => __('Opacity #2', JLTMA_TD),
					'flushing'               => __('Flushing', JLTMA_TD),
					'shine'                  => __('Shine', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'         => __('Thumbnail Shapes', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'description'   => __('Choose an Shapes for Thumbnails', JLTMA_TD),
				'options'       => [
					'none'              => __('None', JLTMA_TD),
					'framed'            => __('Framed', JLTMA_TD),
					'diagonal'          => __('Diagonal', JLTMA_TD),
					'bordered'          => __('Bordered', JLTMA_TD),
					'gradient-border'   => __('Gradient Bordered', JLTMA_TD),
					'squares'           => __('Squares', JLTMA_TD)
				],
				'default'       => 'none',
				'label_block'   => true
			]
		...
		$this->start_controls_section(
			...
			[
				'label'         => __('Posts Settings', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Post Meta Icon', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
				'return_value'  => 'yes'
			]
		...
		$this->add_control(
			...
			[
				'label'         => __('Post Format Icon', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'No',
				'return_value'  => 'yes'
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Ignore Sticky?', JLTMA_TD),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				'label'         => __('Show Content?', JLTMA_TD),
				'description'   => __('Show/Hide Contents', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Show Excerpt ?', JLTMA_TD),
				'description'   => __('Default Except Content Length is 55', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
				'condition'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Excerpt from Content?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'description'   => __('Post content will be pulled from post content box', JLTMA_TD),
				'default'       => 'true',
				'return_value'  => 'true',
				'condition'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Excerpt Length', JLTMA_TD),
				'type'          => Controls_Manager::NUMBER,
				'default'       => 55,
				'condition'     => [
					'ma_el_post_grid_excerpt'  => 'yes',
		...
		$this->add_control(
			...
			[
				'label'         => __('Excerpt Type', JLTMA_TD),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
					'three_dots'        => __('Three Dots', JLTMA_TD),
					'read_more_link'    => __('Read More Link', JLTMA_TD),
				],
		...
		$this->add_control(
			...
			[
				'label'			=> __('Read More Text', JLTMA_TD),
				'type'			=> Controls_Manager::TEXT,
				'default'       => __('Read More', JLTMA_TD),
				'condition'     => [
					'ma_el_post_grid_excerpt'      		=> 'yes',
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Post Title?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Author Avatar?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'no',
				'return_value'  => 'yes'
			]
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Post Author?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Post Date?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Categories?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'no',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Tags?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'no',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Display Comments Number?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Show Read More?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'         => __('Advanced Settings', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __('Offset Post Count', JLTMA_TD),
				'description'   => __('The index of post to start with', JLTMA_TD),
				'type' 			=> Controls_Manager::NUMBER,
				'default' 		=> '0',
				'min' 			=> '0',
			]
		...
		$this->add_control(
			'ma_el_blog_cat_tabs',
			[
				'label'         => __('Category Filter Tabs', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'condition'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Filter By Category', JLTMA_TD),
				'type'          => Controls_Manager::SELECT2,
		...
		$this->add_control(
			'ma_el_blog_tags',
			[
				'label'         => __('Filter By Tag', JLTMA_TD),
				'type'          => Controls_Manager::SELECT2,
				'description'   => __('Get posts for specific tag(s)', JLTMA_TD),
				'label_block'   => true,
				'multiple'      => true,
		...
		$this->add_control(
			'ma_el_blog_users',
			[
				'label'         => __('Filter By Author', JLTMA_TD),
				'type'          => Controls_Manager::SELECT2,
				'description'   => __('Get posts for specific author(s)', JLTMA_TD),
				'label_block'   => true,
				'multiple'      => true,
		...
		$this->add_control(
			...
			[
				'label'         => __('Posts to Exclude', JLTMA_TD),
				'type'          => Controls_Manager::SELECT2,
				'description'   => __('Add post(s) to exclude', JLTMA_TD),
				'label_block'   => true,
				'multiple'      => true,
		...
		$this->add_control(
			'ma_el_blog_new_tab',
			[
				'label'         => __('Links in New Tab', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'description'   => __('Enable links to be opened in a new tab', JLTMA_TD),
				'default'       => 'no',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'         => __('Thumbnail Image', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'         => __('Overlay Color', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Title Padding', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Title Margin', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Content Background Color', JLTMA_TD),
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Box Background Color', JLTMA_TD),
				'type'          => Controls_Manager::COLOR,
				'selectors'     => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Content Padding', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Content Margin', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Article Box Padding', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Hover Text Color', JLTMA_TD),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'  => Color::get_type(),
					'value' => Color::COLOR_3,
		...
		// 	[
		// 		'label' => esc_html__( 'Icon Alignment', JLTMA_TD ),
		// 		'type' => Controls_Manager::CHOOSE,
		// 		'label_block' => false,
		// 		'options' => [
		// 			'left' => [
		...
		$this->add_control(
			...
			[
				'label'         => __('Transparent Icon?', JLTMA_TD),
				'type'          => Controls_Manager::SWITCHER,
				'description'   => __('Show or Hide Thumbnail', JLTMA_TD),
				'default'       => 'yes',
			]
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Inner Padding', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_responsive_control(
			...
			[
				'label'         => __('Item Spacing', JLTMA_TD),
				'type'          => Controls_Manager::DIMENSIONS,
				'size_units'    => ['px', 'em', '%'],
				'selectors'     => [
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/blog-element/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/blog-element-customization/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=03AcgVEsTaA" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
