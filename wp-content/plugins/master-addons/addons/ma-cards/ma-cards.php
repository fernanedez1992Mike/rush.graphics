...
class Master_Addons_Cards extends Widget_Base
{
	...
	{
		return esc_html__('Cards', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'separator' => 'before',
				'default' => esc_html__('Card Title', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			'ma_el_card_tag',
			[
				'label' => esc_html__('Tag', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('Card Tag', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__('Basic description about the Card', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Action Text', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'separator' => 'before',
				'default' => esc_html__('Details', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'one',
				'options' => [
					'one' => esc_html__('Variation 1', JLTMA_TD),
					'two' => esc_html__('Variation 2', JLTMA_TD),
					'three' => esc_html__('Variation 3', JLTMA_TD),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Color Scheme', JLTMA_TD),
