...
class JLTMA_Dual_Heading extends Widget_Base
{
	...
	{
		return esc_html__('Dual Heading', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => '-style2',
				'options' => [
					'-style1' => esc_html__('Style 1', JLTMA_TD),
					'-style2' => esc_html__('Style 2', JLTMA_TD),
					// '-style3' => esc_html__('Background Text', JLTMA_TD),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => esc_html__('First', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Second', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Sub Heading', JLTMA_TD),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'dynamic'     => ['active' => true],
				'default'     => __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto modi vel repudiandae reiciendis, cupiditate quod voluptatibus, placeat ad assumenda molestiae alias quisquam', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/dual-heading/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/dual-heading/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=kXyvNe6l0Sg" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
