...
class JLTMA_Image_Hover_Effects extends Widget_Base
{
	...
	{
		return esc_html__('Image Hover Effects', JLTMA_TD);
	}
	...
	public static function ma_el_image_hover_effects()
	{
		...
		return self::$ma_el_image_hover_effects =
			[
				'lily'    => __('Lily', 	                            JLTMA_TD),
				'sadie'   => __('Sadie', 	                        JLTMA_TD),
				'roxy'    => __('Roxy', 	                            JLTMA_TD),
				'bubba'   => __('Bubba', 	                        JLTMA_TD),
				'romeo'   => __('Romeo', 	                        JLTMA_TD),
				'layla'   => __('Layla', 	                        JLTMA_TD),
				'honey'   => __('Honey', 	                        JLTMA_TD),
				'oscar'   => __('Oscar', 	                        JLTMA_TD),
				'marley'  => __('Marley', 	                        JLTMA_TD),
				'ruby'    => __('Ruby', 	                            JLTMA_TD),
				'milo'    => __('Milo', 	                            JLTMA_TD),
				'dexter'  => __('Dexter', 	                        JLTMA_TD),
				'sarah'   => __('Sarah', 	                        JLTMA_TD),
				'zoe'     => __('Zoe', 	                            JLTMA_TD),
				'chico'   => __('Chico', 	                        JLTMA_TD),
				'julia'   => __('Julia', 	                        JLTMA_TD),
				'goliath' => __('Goliath', 	                        JLTMA_TD),
				'hera'    => __('Hera', 	                            JLTMA_TD),
				'winston' => __('Winston', 	                        JLTMA_TD),
				'selena'  => __('Selena', 	                        JLTMA_TD),
				'terry'   => __('Terry', 	                        JLTMA_TD),
				'phoebe'  => __('Phoebe', 	                        JLTMA_TD),
				'apollo'  => __('Apollo', 	                        JLTMA_TD),
				'kira'    => __('Kira', 	                            JLTMA_TD),
				'steve'   => __('Steve', 	                        JLTMA_TD),
				'moses'   => __('Moses', 	                        JLTMA_TD),
				'jazz'    => __('Jazz', 	                            JLTMA_TD),
				'ming'    => __('Ming', 	                            JLTMA_TD),
				'lexi'    => __('Lexi', 	                            JLTMA_TD),
				'duke'    => __('Duke', 	                            JLTMA_TD),
			];
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Effects & Image', JLTMA_TD),
			]
		);
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					'label'   => esc_html__('Hover Effect', JLTMA_TD),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'ma-el-img-hover1'  => __('Marley (Pro)', JLTMA_TD),
						'ma-el-img-hover2'  => __('Ruby (Pro)', JLTMA_TD),
						'ma-el-img-hover3'  => __('Milo (Pro)', JLTMA_TD),
						'ma-el-img-hover4'  => __('Dexter (Pro)', JLTMA_TD),
						'ma-el-img-hover5'  => __('Sarah (Pro)', JLTMA_TD),
						'ma-el-img-hover6'  => __('Zoe (Pro)', JLTMA_TD),
						'ma-el-img-hover7'  => __('Chico (Pro)', JLTMA_TD),
						'ma-el-img-hover8'  => __('Julia (Pro)', JLTMA_TD),
						'ma-el-img-hover9'  => __('Goliath (Pro)', JLTMA_TD),
						'ma-el-img-hover10' => __('Hera (Pro)', JLTMA_TD),
						'ma-el-img-hover11' => __('Winston (Pro)', JLTMA_TD),
						'ma-el-img-hover12' => __('Selena (Pro)', JLTMA_TD),
						'ma-el-img-hover13' => __('Terry (Pro)', JLTMA_TD),
						'ma-el-img-hover14' => __('Phoebe (Pro)', JLTMA_TD),
						'ma-el-img-hover15' => __('Apollo (Pro)', JLTMA_TD),
						'ma-el-img-hover16' => __('Kira (Pro)', JLTMA_TD),
						'ma-el-img-hover17' => __('Steve (Pro)', JLTMA_TD),
						'ma-el-img-hover18' => __('Moses (Pro)', JLTMA_TD),
						'ma-el-img-hover19' => __('Jazz (Pro)', JLTMA_TD),
						'ma-el-img-hover20' => __('Ming (Pro)', JLTMA_TD),
						'ma-el-img-hover21' => __('Lexi (Pro)', JLTMA_TD),
						'ma-el-img-hover22' => __('Duke (Pro)', JLTMA_TD),
					],
					'description' => sprintf(
		...
		$this->add_control(
			'ma_el_main_image',
			[
				'label'       => __('Upload Image', JLTMA_TD),
				'description' => __('Select an Image', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'main'   => esc_html__('Default', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Links or Popup?', JLTMA_TD),
				...
				'options' => [
					...
					'popup' => [
						'title' => esc_html__('Popup', JLTMA_TD),
						'icon'  => 'eicon-search',
					],
					'links' => [
						'title' => esc_html__('External Links', JLTMA_TD),
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				...
				[
					...
					'label_block' => false,
					'options'     => [
						'image'    => esc_html__('Image', JLTMA_TD),
						'content'  => esc_html__('Content', JLTMA_TD),
						'section'  => esc_html__('Saved Section', JLTMA_TD),
						'widget'   => esc_html__('Saved Widget', JLTMA_TD),
						'template' => esc_html__('Saved Page Template', JLTMA_TD),
					],
					'default'   => 'content',
					'condition' => [
			...
			$this->add_control(
				...
				[
					...
					'label_block' => false,
					'options'     => [
						'image_pro'    => esc_html__('Image (Pro)', JLTMA_TD),
						'content_pro'  => esc_html__('Content (Pro)', JLTMA_TD),
						'section_pro'  => esc_html__('Saved Section (Pro)', JLTMA_TD),
						'widget_pro'   => esc_html__('Saved Widget (Pro)', JLTMA_TD),
						'template_pro' => esc_html__('Saved Page Template (Pro)', JLTMA_TD),
					],
					'default'     => '1',
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'		=> [
					'flex-start' => __('Top', JLTMA_TD),
					'center'     => __('Middle', JLTMA_TD),
					'flex-end'   => __('Bottom', JLTMA_TD),
					'inherit'    => __('Full', JLTMA_TD)
				],
				'default'   => 'flex-start',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __('Title for this Image', JLTMA_TD),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => ['active' => true],
				'default'     => __('Master <span>Addons</span>', JLTMA_TD),
				'label_block' => false
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __('Sub Title for this Image', JLTMA_TD),
				'type'        => Controls_Manager::TEXT,
				'default'     => __('Elementor', JLTMA_TD),
				'label_block' => false
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __('Description', JLTMA_TD),
				'description' => __('Give the description to this banner', JLTMA_TD),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => ['active' => true],
				'default'     => __('Master Addons gives your website a vibrant and lively style, you would love.', JLTMA_TD),
				'label_block' => true,
				'condition'   => [
		...
		$this->start_controls_section(
			...
			[
				'label'       => __('Description', JLTMA_TD),
				'type'        => Controls_Manager::HEADING,
				'description' => __('Write Description Each line', JLTMA_TD),
				'condition'   => [
					'ma_el_main_image_effect' => ['julia']
				]
			]
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Social Links', JLTMA_TD),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'       => __('Social Icons', JLTMA_TD),
				'type'        => Controls_Manager::HEADING,
				'description' => __('Select Social Icons', JLTMA_TD)
			]
		);
		$repeater = new Repeater();
		...
		$this->add_control(
			...
			[
				'label'   => __('Image Opacity', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => .8
				],
		...
		$this->add_control(
			...
			[
				'label'   => __('Hover Opacity', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1
				],
		...
		$this->add_group_control(
			...
			[
				'name'     => 'image_filters',
				'label'    => __('Image Filter', JLTMA_TD),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __('Hover Image Filter', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/image-hover-effects/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/image-hover-effects-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=vWGWzuRKIss" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
		...
		if (ma_el_fs()->is_not_paying()) {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__('Upgrade to Pro', JLTMA_TD)
				]
			);
	...
	protected function render()
	{
		...
		// 	// echo esc_html__('No Image Selected, Please Upload/Select an Image', JLTMA_TD);
				...
				<figcaption>
					...
					<?php } elseif (ma_el_fs()->can_use_premium_code() && $settings['ma_el_image_hover_link_type'] == "popup") { ?>
						...
						<a data-fancybox data-src="#jltma-image-hover-<?php echo $this->get_id(); ?>" href="javascript:;" data-animation-duration="700" data-animation="fade" data-modal="false" <?php if ($settings['ma_el_image_popup_type'] == 'image') {
																																																		echo 'href="' . esc_url($settings['popup_image']['url']) . '" data-fancybox="images"';
																																																	} ?> class="jltma-fancybox elementor-clickable" aria-label="Fancybox Popup">
						</a>
