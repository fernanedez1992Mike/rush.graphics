...
class JLTMA_Infobox extends Widget_Base
{
	...
	{
		return esc_html__('Info Box', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					...
					'default' => 'one',
					'options' => [
						'one'           => esc_html__('Variation One', JLTMA_TD),
						'two'           => esc_html__('Variation Two', JLTMA_TD),
						'three'         => esc_html__('Variation Three', JLTMA_TD),
						'four'          => esc_html__('Variation Four', JLTMA_TD),
						'five'          => esc_html__('Variation Five', JLTMA_TD),
						'six'           => esc_html__('Variation Six', JLTMA_TD),
						'seven'         => esc_html__('Variation Seven', JLTMA_TD),
						'eight'         => esc_html__('Variation Eight', JLTMA_TD),
						'nine'          => esc_html__('Variation Nine', JLTMA_TD),
						'ten'           => esc_html__('Variation Ten', JLTMA_TD),
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'four'          => esc_html__('Variation Four', JLTMA_TD),
						'five'          => esc_html__('Variation Five', JLTMA_TD),
						'info-pro-1'    => esc_html__('Variation Six (Pro)', JLTMA_TD),
						'info-pro-2'    => esc_html__('Variation Seven (Pro)', JLTMA_TD),
						'info-pro-3'    => esc_html__('Variation Eight (Pro)', JLTMA_TD),
						'info-pro-4'    => esc_html__('Variation Nine (Pro)', JLTMA_TD),
						'info-pro-5'    => esc_html__('Variation Ten (Pro)', JLTMA_TD),
					],
					'description' => sprintf(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Image or Icon', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('Infobox Title', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Title URL', JLTMA_TD),
				'type' => Controls_Manager::URL,
				'placeholder' => __('https://your-link.com', JLTMA_TD),
				'label_block' => true,
				'default' => [
					'url' => '',
					'is_external' => true,
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> esc_html__('Basic description about the Infobox', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 		=> esc_html__('Read More Text', JLTMA_TD),
				'type' 			=> Controls_Manager::TEXT,
				'label_block' 	=> true,
				'default' 		=> esc_html__('Learn More', JLTMA_TD),
				'condition' 	=> [
					'ma_el_infobox_preset' => 'six'
				]
			]
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Read More Link', JLTMA_TD),
				'type' 			=> Controls_Manager::URL,
				'placeholder' 	=> __('https://master-addons.com/demo', JLTMA_TD),
				'label_block' 	=> true,
				'default' 		=> [
					'url' 			=> '#',
					'is_external' 	=> true,
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors'	=> [
					'{{WRAPPER}} .jltma-infobox-item' => 'background-color: {{VALUE}}'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('BG Icon Size', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 10,
		...
		$this->add_control(
			...
			[
				'label' => __('BG Icon Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Icon Hover Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/infobox/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/infobox-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=2-ymXAZfrF0" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
