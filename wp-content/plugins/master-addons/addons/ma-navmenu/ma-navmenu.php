...
class JLTMA_Nav_Menu extends Widget_Base
{
    ...
    {
        return __('Navigation Menu', JLTMA_TD);
    }
    ...
    protected function jltma_nav_menu_help_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/elementor-mega-menu/" target="_blank" rel="noopener">', '</a>'),
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/navigation-menu/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
                'content_classes' => 'jltma-editor-doc-links',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=WhA5YnE4yJg" target="_blank" rel="noopener">', '</a>'),
                'content_classes' => 'jltma-editor-doc-links',
            ]
        );
    ...
    protected function jltma_nav_menu_general_section()
    {
        ...
        $this->start_controls_section(
            'jltma_content_tab',
            array('label' => __('General', JLTMA_TD))
        );
        ...
        if (!empty($menus)) {
            ...
            $nav_menu_description = sprintf(__('Add or otherwise manage menus in %s.', JLTMA_TD), sprintf(
                '<a href="%2$s" target="_blank">%1$s</a>',
                __('Menus screen', JLTMA_TD),
            ...
            $no_menu_message_part = sprintf(__('Go to the %s to create one.', JLTMA_TD), sprintf(
                '<a href="%2$s" target="_blank">%1$s</a>',
                __('Menus screen', JLTMA_TD),
            ...
            $no_menu_message = sprintf(
                ...
                __('There are no menus in your site.', JLTMA_TD),
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    'horizontal' => array('title' => __('Horizontal', JLTMA_TD)),
                    'vertical'   => array('title' => __('Vertical', JLTMA_TD)),
                    'dropdown'   => array('title' => __('Dropdown', JLTMA_TD)),
                ),
                'default'            => 'horizontal',
                'label_block'        => false,
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'toggle' => array(
                        'title' => __('Toggle', JLTMA_TD),
                        'description' => 'Toggle view menu',
                    ),
                    'accordion' => array(
                        'title' => __('Accordion', JLTMA_TD),
                        'description' => 'Accordion view menu',
                    ),
                    'side' => array(
                        'title' => __('Side', JLTMA_TD),
        ...
        $this->add_control(
            ...
            array(
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __('Only the main menu items are displayed, subitems are hidden.', JLTMA_TD),
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                'condition' => array(
                    'layout' => 'vertical',
        ...
        $this->add_responsive_control(
            'menu_alignment',
            [
                'label'        => __('Menu Alignment', JLTMA_TD),
                'type'         => Controls_Manager::CHOOSE,
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Dropdown Indicator', JLTMA_TD),
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'rotate-left' => __('Rotate Left', JLTMA_TD),
                    'rotate-right' => __('Rotate Right', JLTMA_TD),
                    'rotate-opposite' => __('Rotate Opposite', JLTMA_TD),
                    'opacity' => __('Opacity', JLTMA_TD),
                ),
                'default' => 'none',
                'conditions' => array(
                    'relation' => 'and',
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Breakpoint', JLTMA_TD),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'none' => __('None', JLTMA_TD),
                    /* translators: Tablet breakpoint %d: number in pixels. */
                    'tablet' => sprintf(__('Tablet (< %dpx)', JLTMA_TD), Master_Addons_Helper::get_breakpoints('tablet')),
                    /* translators: Mobile breakpoint %d: number in pixels. */
                    'mobile' => sprintf(__('Mobile (< %dpx)', JLTMA_TD), Master_Addons_Helper::get_breakpoints('mobile')),
                ),
                'default' => 'tablet',
                'frontend_available' => true,
                'render_type' => 'template',
        ...
        $this->add_control(
            'open_by_click',
            array(
                'label' => __('Open link by click (menu item)', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', JLTMA_TD),
                'label_off' => __('No', JLTMA_TD),
                'return_value' => 'true',
                'default' => 'false',
                'description' => sprintf(__('If link # or empty, there will be no link', JLTMA_TD)),
                'condition' => array(
                    'layout' => 'vertical',
        ...
        $this->add_control(
            'dropdown_absolute',
            array(
                'label' => __('Overlap Content', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'description' => __('Set Dropdown Menu position to absolute. On desktop, this will affect the Layout: Dropdown. When chosen Breakpoint for Tablet or Mobile this will also affect the Layouts: Dropdown, Horizontal, Vertical (except the Side type).', JLTMA_TD),
                'separator' => 'before',
                'render_type' => 'template',
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Dropdown Position', JLTMA_TD),
                'type' => Controls_Manager::CHOOSE,
                'options' => array(
                    'left' => array(
                        'title' => __('Left Side', JLTMA_TD),
                        'icon' => 'eicon-h-align-left',
                    ),
                    'right' => array(
                        'title' => __('Right Side', JLTMA_TD),
                        'icon' => 'eicon-h-align-right',
                    ),
                ),
                'render_type' => 'template',
        ...
        $this->add_responsive_control(
            'widget_min_width',
            array(
                'label' => __('Dropdown Min Width', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                    'vw',
        ...
        $this->add_control(
            'dropdown_position',
            array(
                'label' => __('Dropdown Placement', JLTMA_TD),
                'type' => Controls_Manager::CHOOSE,
                'options' => array(
                    'left' => array(
                        'title' => __('Left Side', JLTMA_TD),
    ...
    protected function jltma_nav_menu_toggle_switch_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Toggle Switch', JLTMA_TD),
                'conditions' => array(
                    'relation' => 'or',
                    'terms' => array(
                        array(
        ...
        $this->add_control(
            ...
            array(
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __('This toggle will appear on resolutions below the one defined in Breakpoint settings.', JLTMA_TD),
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                'condition' => array(
                    'layout!' => 'dropdown',
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => 'jltma-choose-text',
                'options' => array(
                    'default' => array('title' => __('Default', JLTMA_TD)),
                    'stacked' => array('title' => __('Stacked', JLTMA_TD)),
                    'framed' => array('title' => __('Framed', JLTMA_TD)),
                ),
                'default' => 'stacked',
                'label_block' => false,
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => 'jltma-choose-text',
                'options' => array(
                    'square' => array('title' => __('Square', JLTMA_TD)),
                    'circle' => array('title' => __('Circle', JLTMA_TD)),
                ),
                'default' => 'square',
                'label_block' => false,
        ...
        $this->start_controls_tab(
            ...
            array('label' => __('Normal', JLTMA_TD))
        );
        ...
        $this->start_controls_tab(
            ...
            array('label' => __('Active', JLTMA_TD))
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Position', JLTMA_TD),
                'type' => 'jltma-choose-text',
                'description' => __('Will be applied only if Justified Alignment is chosen.', JLTMA_TD),
                'options' => array(
                    'central' => array(
                        'title' => __('Central', JLTMA_TD),
                    ),
                    'on-sides' => array(
                        'title' => __('On Sides', JLTMA_TD),
                    ),
                ),
                'default' => 'central',
                'label_block' => false,
        ...
        $this->add_control(
            'dropdown_toggle_gap',
            array(
                'label' => __('Horizontal Gap', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'size_units' => array('px'),
                'range' => array(
                    'px' => array(
    ...
    protected function jltma_nav_menu_dropdown_menu_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Dropdown Menu', JLTMA_TD),
                'conditions' => array(
                    'relation' => 'or',
                    'terms' => array(
                        array(
        ...
        $this->add_control(
            'full_width',
            array(
                'label' => __('Full Width', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'description' => __('Stretch the dropdown of the menu to full width.', JLTMA_TD),
                'render_type' => 'template',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__('Submenu Indicator', JLTMA_TD),
                'type' => Controls_Manager::POPOVER_TOGGLE,
                'render_type' => 'template',
            )
        );
    ...
    protected function jltma_nav_menu_popup_offcanvas_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Popup / Offcanvas Settings', JLTMA_TD),
                'condition' => array(
                    'layout' => 'dropdown',
                    'dropdown_menu_type!' => 'default',
                ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Canvas Width', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 100,
        ...
        $this->add_control(
            'overlay_close',
            array(
                'label' => __('Close With Click on Overlay', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'description' => __('Close popup upon click/tap on overlay', JLTMA_TD),
                'frontend_available' => true,
                'separator' => 'before',
                'condition' => array(
                    'layout' => 'dropdown',
        ...
        $this->add_control(
            'esc_close',
            array(
                'label' => __('Close by ESC Button Click', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'frontend_available' => true,
                'condition' => array(
        ...
        $this->add_control(
            'disable_scroll',
            array(
                'label' => __('Disable scroll', JLTMA_TD),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'frontend_available' => true,
                'condition' => array(
    ...
    protected function jltma_nav_menu_item_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Main Menu Item', JLTMA_TD),
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Item Background Color', JLTMA_TD),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
                    '{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-horizontal > ul > li > a,
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'fields_options' => array(
                    'text_shadow_type' => array('label' => __('Text Shadow', JLTMA_TD)),
                ),
                'selector' => '{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-horizontal > ul > li > a,
					{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-vertical.jltma-vertical-type-normal > ul > li > a,
					{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-vertical.jltma-vertical-type-side > ul > li > a',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'   => __('Horizontal Padding', JLTMA_TD),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'   => __('Vertical Padding', JLTMA_TD),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Space Between', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array('max' => 100),
                ),
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'fields_options' => array(
                    'border' => array(
                        'options' => array(
                            'none' => _x('None', 'Border Control', JLTMA_TD),
                            'default' => _x('Default', 'Border Control', JLTMA_TD),
                            'solid' => _x('Solid', 'Border Control', JLTMA_TD),
                            'double' => _x('Double', 'Border Control', JLTMA_TD),
                            'dotted' => _x('Dotted', 'Border Control', JLTMA_TD),
                            'dashed' => _x('Dashed', 'Border Control', JLTMA_TD),
                            'groove' => _x('Groove', 'Border Control', JLTMA_TD),
                        ),
                        'default' => 'default',
                    ...
                    'width' => array(
                        'label' => _x('Border Width', 'Border Control', JLTMA_TD),
                        'selectors' => array(
                            '{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-horizontal > ul > li > a,
							{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-vertical.jltma-vertical-type-normal > ul > li > a,
    ...
    protected function jltma_nav_menu_side_box_section()
    {
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'fields_options' => array(
                    ...
                    'color' => array(
                        'label' => _x('Border Color', 'Border Control', JLTMA_TD),
                        'condition' => array(
                            'border!' => array(
                                'none',
                                'default',
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Text Decoration', JLTMA_TD),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''             => __('Default', JLTMA_TD),
                    'none'         => _x('None', 'Typography Control', JLTMA_TD),
                    'underline'    => _x('Underline', 'Typography Control', JLTMA_TD),
                    'overline'     => _x('Overline', 'Typography Control', JLTMA_TD),
                    'line-through' => _x('Line Through', 'Typography Control', JLTMA_TD),
                ],
                'selectors' => [
        ...
        $this->add_control(
            'dropdown_toggle_framed_border_style',
            array(
                'label' => _x('Border Type', 'Border Control', JLTMA_TD),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    '' => __('None', JLTMA_TD),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Popup / Offcanvas', JLTMA_TD),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'layout' => 'dropdown',
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Vertical Alignment', JLTMA_TD),
                'type' => Controls_Manager::CHOOSE,
                'options' => array(
                    'flex-start' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Close Button', JLTMA_TD),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
                    'layout' => 'dropdown',
    ...
    protected function jltma_nav_menu_dropdown_list_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Dropdown List', JLTMA_TD),
                'tab' => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Gap from Top', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => -30,
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Horizontal Gap', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'description' => __('Gap between dropdown list columns.', JLTMA_TD),
                'range' => array(
                    'px' => array(
                        'min' => -30,
                        'max' => 70,
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Sublevel list Gap', JLTMA_TD),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => array('px'),
                'default' => array(
                    'isLinked' => false,
    ...
    protected function jltma_nav_menu_dropdown_item_section()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Dropdown Item', JLTMA_TD),
                'tab' => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Custom Sublevel Styles', JLTMA_TD),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'conditions' => $dropdown_sublevels_level_conditions,
            )
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Divider Type', JLTMA_TD),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'none' => __('None', JLTMA_TD),
                    'solid' => __('Solid', JLTMA_TD),
                    'double' => __('Double', JLTMA_TD),
                    'doted' => __('Doted', JLTMA_TD),
                    'dashed' => __('Dashed', JLTMA_TD),
                    'groove' => __('Groove', JLTMA_TD),
                ),
                'default' => 'none',
                'selectors' => array(
                    '{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-horizontal > ul ul li:not(:first-child),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => __('Divider Size', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array('max' => 15),
                ),
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Divider Color', JLTMA_TD),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-horizontal > ul ul li:not(:first-child),
					{{WRAPPER}} ' . $widget_selector . '__main.jltma-layout-vertical.jltma-vertical-type-normal > ul ul li:not(:first-child),
    ...
    public function get_dropdown_close()
    {
        ...
        if ('icon' !== $close_type) {
            ...
            if ('' !== $close_text) {
                ...
                echo esc_html__('Close', JLTMA_TD);
            }
