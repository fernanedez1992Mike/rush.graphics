...
class JLTMA_Progress_Bar extends Widget_Base
{
	...
	{
		return esc_html__('Progressbar', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('Progress Bar', JLTMA_TD),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __('Style Presets', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'line'        => __('Line', JLTMA_TD),
					'line-bubble' => __('Line Bubble', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => __('Bubble Color', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/progress-bar/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/how-to-create-and-customize-progressbar-in-elementor/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=77-b1moRE8M" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
