...
class JLTMA_Dynamic_Table extends Widget_Base
{
    ...
    {
        return __('Dynamic Table', JLTMA_TD);
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->start_controls_tab('head_tab_contents', ['label' => __('Content', JLTMA_TD)]);
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'label'       => __('Column Name', JLTMA_TD),
                'default'     => __('Table Header', JLTMA_TD),
                'dynamic'     => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            'header_image_size',
            [
                'label'       => __('Image Size(px)', JLTMA_TD),
        ...
        $repeater->start_controls_tab('ma_el_table_head_tab_options', ['label' => __('Options', JLTMA_TD)]);

        $repeater->add_control(
            'colspannumber',
            [
                'label' => __('Column Span', JLTMA_TD),
                'type'  => Controls_Manager::TEXT
            ]
        );
        ...
        $repeater->add_control(
            'customwidth',
            [
                'label'     => __('Custom Width', JLTMA_TD),
        ...
        $repeater->add_control(
            'decoration',
            [
                'label'   => __('Decoration', JLTMA_TD),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''             => __('Default', JLTMA_TD),
                    'underline'    => __('Underline', JLTMA_TD),
                    'overline'     => __('Overline', JLTMA_TD),
                    'line-through' => __('Line Through', JLTMA_TD),
        ...
        $this->add_control(
            'ma_el_table_header',
            [
                'label'     => __('Table Header Cell', JLTMA_TD),
                'type'      => Controls_Manager::REPEATER,
                'seperator' => 'before',
                'default'   => [
                    [
                        'title' => __('First Name', JLTMA_TD),
                    ],
                    [
                        'title' => __('Last Name', JLTMA_TD),
                    ],
                    [
                        'title' => __('Job Title', JLTMA_TD),
                    ],
                    [
                        'title' => __('Twitter', JLTMA_TD),
                    ]
                ],
        ...
        $repeater->start_controls_tab('body_tab_contents', ['label' => __('Content', JLTMA_TD)]);
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'label'       => __('Body Text', JLTMA_TD),
                'default'     => __('Table Body', JLTMA_TD),
                'dynamic'     => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->start_controls_tab('ma_el_table_body_tab_options', ['label' => __('Options', JLTMA_TD)]);
        $repeater->add_control(
            'colspannumber',
            [
                'label' => __('Column Span', JLTMA_TD),
        ...
        $repeater->add_control(
            'rowspannumber',
            [
                'label'       => __('Row Span', JLTMA_TD),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('', JLTMA_TD),
                'default'     => __('', JLTMA_TD),
            ]
        );
        ...
        $this->add_control(
            'ma_el_table_body',
            [
                'label'     => __('Table Body Cell', JLTMA_TD),
                'type'      => Controls_Manager::REPEATER,
                'seperator' => 'before',
                'default'   => [
                    [
                        'text' => __('Liton', JLTMA_TD),
                    ],
                    [
                        'text' => __('Arefin', JLTMA_TD),
                    ],
                    [
                        'text' => __('Developer', JLTMA_TD),
                    ],
                    [
                        'text' => __('Litonice11', JLTMA_TD),
                    ],
                    [
                        'body_row' => 'yes',
                        'text'     => __('Roy', JLTMA_TD),
                    ],
                    [
                        'text' => __('Jemee', JLTMA_TD),
                    ],
                    [
                        'text' => __('Content Writer', JLTMA_TD),
                    ],
                    [
                        'text' => __('@Litonice11', JLTMA_TD),
                    ],
                    ...
                    [
                        'body_row' => 'yes',
                        'text'     => __('Akbar', JLTMA_TD),
                    ],
                    [
                        'text' => __('Hossain', JLTMA_TD),
                    ],
                    [
                        'text' => __('Designer', JLTMA_TD),
                    ],
                    [
                        'text' => __('@AkbarHo33850947', JLTMA_TD),
                    ],

                    [
                        'body_row' => 'yes',
                        'text'     => __('Jewel', JLTMA_TD),
                    ],
                    [
                        'text' => __('Theme', JLTMA_TD),
                    ],
                    [
                        'text' => __('Website', JLTMA_TD),
                    ],
                    [
                        'text' => __('@jwthemeltd', JLTMA_TD),
                    ]
                ],
                'fields'      => $repeater->get_controls(),
                'title_field' => '{{{ text }}}'
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/dynamic-table/" target="_blank" rel="noopener">', '</a>'),
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/dynamic-table-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
                'content_classes' => 'jltma-editor-doc-links',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=bn0TvaGf9l8" target="_blank" rel="noopener">', '</a>'),
                'content_classes' => 'jltma-editor-doc-links',
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Global Style', JLTMA_TD),
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Striped Table?', JLTMA_TD),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'return_value' => 'yes'
            ]
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Striped Background Color', JLTMA_TD),
        ...
        $this->add_control(
            'ma_el_table_padding',
            [
                'label'      => __('Inner Cell Padding', JLTMA_TD),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Table Header Style', JLTMA_TD),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
