...
class JLTMA_Tabs extends Widget_Base
{
	...
	{
		return esc_html__('Advanced Tabs', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Presets', JLTMA_TD)
			]
		);
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'two'       => esc_html__('Horizontal Tabs', JLTMA_TD),
						'three'     => esc_html__('Vertical Tabs', JLTMA_TD),
						'four'      => esc_html__('Left Active Border', JLTMA_TD),
						'five'      => esc_html__('Tabular Content', JLTMA_TD),
					]
				]
			);
		} else {
			...
			$this->add_control(
				...
				[
					...
					'options' 		=> [
						...
						'three'     => esc_html__('Vertical Tabs', JLTMA_TD),
						'four'      => esc_html__('Left Active Border', JLTMA_TD),
						'ma_tabular_pro'      => esc_html__('Tabular Content (Pro)', JLTMA_TD),
					],
				]
			);
		}
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Enable Icon', JLTMA_TD),
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_responsive_control(
				...
				[
					'label'                 => esc_html__('Column Layout', JLTMA_TD),
					'type'                  => Controls_Manager::SELECT,
					'label_block'           => false,
					'default'               => '7-5',
					'tablet_default'        => '7-5',
					...
					'options'               => [
						'6-6'              => esc_html__('Col 6/6', JLTMA_TD),
						'7-5'              => esc_html__('Col 7/5', JLTMA_TD),
						'5-7'              => esc_html__('Col 5/7', JLTMA_TD),
						'8-4'              => esc_html__('Col 8/4', JLTMA_TD),
						'4-8'              => esc_html__('Col 4/8', JLTMA_TD),
						'9-3'              => esc_html__('Col 9/3', JLTMA_TD),
						'3-9'              => esc_html__('Col 3/9', JLTMA_TD),
						'10-2'             => esc_html__('Col 10/2', JLTMA_TD),
						'2-10'             => esc_html__('Col 2/10', JLTMA_TD),
						'11-1'             => esc_html__('Col 12/1', JLTMA_TD),
						'1-11'             => esc_html__('Col 1/12', JLTMA_TD),
						'12-12'            => esc_html__('Col 12(Full Width)', JLTMA_TD),
					],
					'condition' => [
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_responsive_control(
				...
				[
					'label'                 => esc_html__('Icon & Tabs Style', JLTMA_TD),
					'type'                  => Controls_Manager::CHOOSE,
					'label_block'           => false,
					'default'               => 'block',
					'options' 		=> [
						'inline-block' 	=> [
							'title' 	=> esc_html__('Inline', JLTMA_TD),
							'icon' 		=> 'eicon-editor-list-ul',
						],
						'block' 		=> [
							'title' 		=> esc_html__('Boxed', JLTMA_TD),
							'icon' 			=> 'eicon-info-box',
						],
					],
					'selectors'  => [
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_responsive_control(
				...
				[
					'label'                 => esc_html__('Tabs & Content Style', JLTMA_TD),
					'type'                  => Controls_Manager::SELECT,
					'label_block'           => false,
					'default'               => 'float-left',
					'options'               => [
						'float-left'              	=> esc_html__('Left Tabs - Right Content', JLTMA_TD),
						'float-right'               => esc_html__('Right Tabs - Left Content', JLTMA_TD)
					],
					'condition' => [
						'ma_el_tabs_preset' 		=> 'five',
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__('Tabs Orientation', JLTMA_TD),
					'type' 			=> Controls_Manager::CHOOSE,
					'label_block' 	=> false,
					'options' 		=> [
						'inline-block' 	=> [
							'title' 	=> esc_html__('Grid', JLTMA_TD),
							'icon' 		=> 'eicon-gallery-grid',
						],
						'block' 		=> [
							'title' 		=> esc_html__('Vertical', JLTMA_TD),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => __('Set as Default', JLTMA_TD),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'active',
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'       => esc_html__('Icon Type', JLTMA_TD),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options'     => [
					'none' => [
		...
		$repeater->add_control(
			'ma_el_tab_title',
			[
				'label' => esc_html__('Tab Title', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__('Tab Title', JLTMA_TD),
				'dynamic' => ['active' => true]
			]
		);
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$repeater->add_control(
				'ma_el_tab_content',
				[
					'label'                 => esc_html__('Tab Content', JLTMA_TD),
					'type'                  => Controls_Manager::WYSIWYG,
					'default'               => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, neque qui velit. Magni dolorum quidem ipsam eligendi, totam, facilis laudantium cum accusamus ullam voluptatibus commodi numquam, error, est. Ea, consequatur.', JLTMA_TD),
					'condition'             => [
		...
		$this->add_control(
			...
			[
				...
				'default'               => [
					['ma_el_tab_title' => esc_html__('Tab Title One', JLTMA_TD)],
					['ma_el_tab_title' => esc_html__('Tab Title Two', JLTMA_TD)],
					['ma_el_tab_title' => esc_html__('Tab Title Three', JLTMA_TD)],
				],
		...
		$this->add_control(
			'ma_el_tabs_effect',
			[
				'label'       => esc_html__('Tab Effect', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'label_block' => false,
				'options' 		=> [
					'hover'       	=> esc_html__('Hover', JLTMA_TD),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Tabs', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bottom Border Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#e5e5e5',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'   		=> esc_html__('Icon Font Size (px)', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bottom Left Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#704aff',
				'selectors' => [
					'{{WRAPPER}} .jltma--advance-tab.four .jltma--advance-tab-nav li::after' => 'background: {{VALUE}};'
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Title Typography', JLTMA_TD),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Content Typography', JLTMA_TD),
		...
		if (ma_el_fs()->is_not_paying()) {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__('Upgrade to Pro Nested Tabs', JLTMA_TD),
				]
			);
...
<?php
	...
	public function get_page_template_options($type = '')
	{
		...
		$options[-1]   = esc_html__('Select', JLTMA_TD);
		...
		if (count($page_templates)) {
			...
			$options['no_template'] = esc_html__('No saved templates found!', JLTMA_TD);
		}
