...
class JLTMA_Team_Slider extends Widget_Base
{
	...
	{
		return esc_html__('Team Slider', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				...
				[
					...
					'default' => '-default',
					'options' => [
						'-default'              => __('Team Carousel', JLTMA_TD),
						'-circle'               => __('Circle Gradient', JLTMA_TD),
						'-circle-animation'     => __('Circle Animation', JLTMA_TD),
						'-social-left'          => __('Social Left on Hover', JLTMA_TD),
						'-content-hover'        => __('Content on Hover', JLTMA_TD),
						'-content-drawer'       => __('Content Drawer', JLTMA_TD),
					],
			...
			$this->add_control(
				'ma_el_team_carousel_preset',
				[
					'label' 					=> __('Style Preset', JLTMA_TD),
					'type' 						=> Controls_Manager::SELECT,
					'default' 					=> '-default',
					'options' => [
						'-default'                    => __('Team Carousel', JLTMA_TD),
						'-circle'                     => __('Circle Gradient', JLTMA_TD),
						'-content-hover'              => __('Content on Hover', JLTMA_TD),
						'-pro-team-slider-1'          => __('Social Left on Hover (Pro)', JLTMA_TD),
						'-pro-team-slider-2'          => __('Content Drawer (Pro)', JLTMA_TD),
						'-pro-team-slider-3'          => __('Circle Animation (Pro)', JLTMA_TD)
					],
					'frontend_available' 		=> true,
					'description' 				=> sprintf(
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				...
				[
					'label' => esc_html__('Circle Gradient Image', JLTMA_TD),
					'type' => Controls_Manager::SELECT,
					'default' => 'circle_01',
					'options' => [
						'circle_01'                   => esc_html__('Circle 01', JLTMA_TD),
						'circle_02'                   => esc_html__('Circle 02', JLTMA_TD),
						'circle_03'                   => esc_html__('Circle 03', JLTMA_TD),
						'circle_04'                   => esc_html__('Circle 04', JLTMA_TD),
						'circle_05'                   => esc_html__('Circle 05', JLTMA_TD),
						'circle_06'                   => esc_html__('Circle 06', JLTMA_TD),
						'circle_07'                   => esc_html__('Circle 07', JLTMA_TD),
					],
					'condition' => [
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'circle_02'                   	 => esc_html__('Circle 02', JLTMA_TD),
						'circle_03'                   	 => esc_html__('Circle 03', JLTMA_TD),
						'circle-pro-1'                   => esc_html__('Circle 04 (Pro)', JLTMA_TD),
						'circle-pro-2'                   => esc_html__('Circle 05 (Pro)', JLTMA_TD),
						'circle-pro-3'                   => esc_html__('Circle 06 (Pro)', JLTMA_TD),
						'circle-pro-4'                   => esc_html__('Circle 07 (Pro)', JLTMA_TD),
					],
					'condition' => [
						'ma_el_team_carousel_preset' => '-circle'
					],
		...
		if (!ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				...
				[
					'label'       => esc_html__('Animation Style', JLTMA_TD),
					'type'        => Controls_Manager::SELECT,
					'default'     => 'animation_svg_01',
					'options'     => [
						'animation_svg_01' 		=> esc_html__('Animation 1', JLTMA_TD),
						'animation_svg_02' 		=> esc_html__('Animation 2', JLTMA_TD),
						'animation_svg_03' 		=> esc_html__('Animation 3', JLTMA_TD),
						'svg_animated_pro_1' 	=> esc_html__('Animation 4 (Pro)', JLTMA_TD),
						// 'svg_animated_pro_2' 	=> esc_html__('Animation 5 (Pro)', JLTMA_TD),
						// 'svg_animated_pro_3' 	=> esc_html__('Animation 6 (Pro)', JLTMA_TD),
						// 'svg_animated_pro_4' 	=> esc_html__('Animation 7 (Pro)', JLTMA_TD),
					],
					'condition'   => [
			...
			$this->add_control(
				...
				[
					...
					'options'     => [
						...
						'animation_svg_02' => esc_html__('Animation 2', JLTMA_TD),
						'animation_svg_03' => esc_html__('Animation 3', JLTMA_TD),
						'animation_svg_04' => esc_html__('Animation 4', JLTMA_TD),
						// 'animation_svg_05' => esc_html__('Animation 5', JLTMA_TD),
						// 'animation_svg_06' => esc_html__('Animation 6', JLTMA_TD),
						// 'animation_svg_07' => esc_html__('Animation 7', JLTMA_TD),
					],
					'condition'   => [
						'ma_el_team_carousel_preset' => '-circle-animation'
					]
		...
		$team_repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('John Doe', JLTMA_TD),
			]
		);
		...
		$team_repeater->add_control(
			...
			[
				'label' => esc_html__('Designation', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('My Designation', JLTMA_TD),
			]
		);
		...
		$team_repeater->add_control(
			...
			[
				...
				'default' => esc_html__('Add team member details here', JLTMA_TD),
			]
		);
		...
		$team_repeater->add_control(
			...
			[
				'label' => esc_html__('Display Social Profiles?', JLTMA_TD),
		...
		$team_repeater->add_control(
			...
			[
				'label' => __('Facebook URL', JLTMA_TD),
				'type' => Controls_Manager::URL,
				'condition' => [
					'ma_el_team_carousel_enable_social_profiles!' => '',
				],
				'placeholder' => __('https://master-addons.com', JLTMA_TD),
				'label_block' => true,
				'default' => [
					'url' => '',
					'is_external' => true,
		...
		$team_repeater->add_control(
			...
			[
				'label' => __('Instagram URL', JLTMA_TD),
				'type' => Controls_Manager::URL,
				'condition' => [
					'ma_el_team_carousel_enable_social_profiles!' => '',
				],
		...
		$team_repeater->add_control(
			...
			[
				'label' => __('Linkedin URL', JLTMA_TD),
				'type' => Controls_Manager::URL,
				'condition' => [
					'ma_el_team_carousel_enable_social_profiles!' => '',
				],
		...
		$team_repeater->add_control(
			...
			[
				'label' => __('Dribbble URL', JLTMA_TD),
				'type' => Controls_Manager::URL,
				'condition' => [
					'ma_el_team_carousel_enable_social_profiles!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Team Carousel', JLTMA_TD),
				'type' => Controls_Manager::REPEATER,
				'fields' => $team_repeater->get_controls(),
				'title_field' => '{{{ ma_el_team_carousel_name }}}',
				'default' => [
					[
						'ma_el_team_carousel_name' => __('Member #1', JLTMA_TD),
						'ma_el_team_carousel_description' => __('Add team member details here', JLTMA_TD),
					],
					[
						'ma_el_team_carousel_name' => __('Member #2', JLTMA_TD),
						'ma_el_team_carousel_description' => __('Add team member details here', JLTMA_TD),
					],
					[
						'ma_el_team_carousel_name' => __('Member #3', JLTMA_TD),
						'ma_el_team_carousel_description' => __('Add team member details here', JLTMA_TD),
					],
					[
						'ma_el_team_carousel_name' => __('Member #4', JLTMA_TD),
						'ma_el_team_carousel_description' => __('Add team member details here', JLTMA_TD),
					],
				]
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('General Styles', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Background Image Size', JLTMA_TD),
				'description' => __('Height Width will be same ratio', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Background Position(Left)', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', 'em'],
				'default' => [
					'unit' => 'px',
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Background Position(Top)', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', 'em'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Member Image Size', JLTMA_TD),
				'description' => __('Height Width will be same ratio', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units'    => ['px'],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Member Image Position(Left)', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', 'em'],
				'default' => [
					'unit' => '%',
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Member Image Position(Top)', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%', 'em'],
				'default' => [
					'unit' => '%',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Avatar Background Color', JLTMA_TD),
		...
		*/
		...
		$this->add_responsive_control(
			...
			[
				'type'        => Controls_Manager::SELECT,
				'label'       => __('Slides per Column', JLTMA_TD),
				'description' => __('For Vertical direction this defines the number of slides per row.', JLTMA_TD),
				'options'     => ['' => __('Default', JLTMA_TD)] + $slides_per_column,
				'default'     => 4,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/team-carousel/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/team-members-carousel/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=ubP_h86bP-c" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Hover Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Hover Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#ff6d55',
				'selectors' => [
				...
				<ul class="gridder">
					...
					?>
						...
						<li class="gridder-list" data-griddercontent="#jltma-team<?php echo esc_attr($key) + 1; ?>">
							<img src="<?php echo esc_url($team_carousel_image_url); ?>" class="jltma-circled" alt="<?php echo esc_attr($member['ma_el_team_carousel_name']); ?>">
								...
								<div class="jltma-team-member<?php echo esc_attr($team_preset); ?> text-center">
									<div class="jltma-team-member-thumb">
										...
										if ($team_preset == '-circle' && isset($settings['ma_el_team_circle_image'])) {
											...
											echo '<img src="' . esc_url($team_carousel_image_url) . '" class="jltma-circled" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '">';
											...
											if ($settings['ma_el_team_circle_image_animation'] == "animation_svg_02") {
												...
												echo '<div class="animation_svg_02"><img src="' . esc_url($team_carousel_image_url) . '" class="jltma-circled" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '"></div>';
											} elseif ($settings['ma_el_team_circle_image_animation'] == "animation_svg_03") {

												echo '<div class="animation_svg_03"></div><div class="animation_svg_03"></div><div class="animation_svg_03"></div><div class="animation_svg_03_center"><img src="' . esc_url($team_carousel_image_url) . '" class="jltma-circled" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '"></div>';
											} else {
