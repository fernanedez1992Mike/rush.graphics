...
class JLTMA_Team_Member extends Widget_Base
{
	...
	{
		return esc_html__('Team Member', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					'label' => esc_html__('Design Variations', JLTMA_TD),
					'type' => Controls_Manager::SELECT,
					'default' => '-basic',
					'options' => [
						'-basic'            => esc_html__('Basic One', JLTMA_TD),
						'-basic-2'          => esc_html__('Basic Two', JLTMA_TD),
						'-basic-3'          => esc_html__('Basic Three', JLTMA_TD),
						'-basic-4'          => esc_html__('Basic Four', JLTMA_TD),
						'-basic-5'          => esc_html__('Basic Five', JLTMA_TD),
						'-circle'           => esc_html__('Circle Gradient', JLTMA_TD),
						'-circle-2'         => esc_html__('Circle No Gradient', JLTMA_TD),
						'-social-left'      => esc_html__('Social Left on Hover', JLTMA_TD),
						'-social-right'     => esc_html__('Social Right on Hover', JLTMA_TD),
						'-rounded'          => esc_html__('Rounded', JLTMA_TD),
						'-content-hover'    => esc_html__('Content on Hover', JLTMA_TD)
					],
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'-basic-5'          => esc_html__('Basic Five', JLTMA_TD),
						'-rounded'          => esc_html__('Rounded', JLTMA_TD),
						'-pro-team-1'       => esc_html__('Circle Gradient (Pro)', JLTMA_TD),
						'-pro-team-2'       => esc_html__('Circle No Gradient (Pro)', JLTMA_TD),
						'-pro-team-3'       => esc_html__('Social Left on Hover (Pro)', JLTMA_TD),
						'-pro-team-4'       => esc_html__('Social Right on Hover (Pro)', JLTMA_TD),
						'-pro-team-5'       => esc_html__('Content on Hover (Pro)', JLTMA_TD)
					],
					'description' => sprintf(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Social Profiles', JLTMA_TD)
			]
		);
		$this->add_control(
		...
		$social_repeater->add_control(
			'link',
			[
				'label' => esc_html__('Link', JLTMA_TD),
				...
				'placeholder' => esc_html__('Place URL here', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/team-member/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/adding-team-members-in-elementor-page-builder/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=wXPEl93_UBw" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
...
Customization Options.</span>'
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __('Item Border Radius', JLTMA_TD),
		...
		$this->add_group_control(
			...
			[
				...
				'default'     => '0',
				'selector' => '{{WRAPPER}} .jltma-team-member-item ',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Background Color 2', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#272c44',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Hover BG Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#ff6d55',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Hover BG Color 2', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#ff6d55',
				'selectors' => [
