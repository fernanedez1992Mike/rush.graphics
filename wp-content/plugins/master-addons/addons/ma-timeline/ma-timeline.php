	...
	protected function register_controls()
	{
		...
		if (ma_el_fs()->can_use_premium_code()) {
			$this->add_control(
				'ma_el_timeline_type',
				[
					'label'   => __('Timeline Type', JLTMA_TD),
					'type'    => Controls_Manager::SELECT,
					'default' => 'post',
					'options' => [
						'post'   => __('Post Timeline', JLTMA_TD),
						'custom' => __('Custom Timeline', JLTMA_TD),
					],
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'default' => 'custom',
					'options' => [
						'timeline-post' => __('Post Timeline (Pro)', JLTMA_TD),
						'custom'        => __('Custom Timeline', JLTMA_TD),
					],
				]
			);
		...
		$this->add_control(
			...
			[
				'label'   => __('Timeline Style', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'vertical'   => __('Vertical Timeline', JLTMA_TD),
					'horizontal' => __('Horizontal Timeline', JLTMA_TD)
				],
				'default'   => 'vertical',
				'condition' => [
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$this->add_control(
				...
				[
					'label'        => __('Enable Links', JLTMA_TD),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => __('Yes', JLTMA_TD),
					'label_off'    => __('No', JLTMA_TD),
					'return_value' => 'yes',
					'description'  => __('Enable links at card level. If you have links inside the content of a card, make sure you have this disabled. Links within links are not allowed.', JLTMA_TD),
					'condition'    => [
						'ma_el_timeline_type' => 'post',
					]
				]
			...
			$this->add_control(
				...
				[
					'label'   => __('Date Source', JLTMA_TD),
					'type'    => Controls_Manager::SELECT,
					'options' => [
						''       => __('Post Date', JLTMA_TD),
			...
			$this->add_control(
				...
				[
					'label'       => __('Custom Format', JLTMA_TD),
					'default'     => get_option('date_format') . ' ' . get_option('time_format'),
					'description' => sprintf('<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">%s</a>', __('Documentation on date and time formatting', JLTMA_TD)),
					'condition'   => [
						'ma_el_timeline_type'        => 'post',
		...
		$repeater->add_control(
			...
			[
				...
				'dynamic'        => ['active' => true],
				'default'        => __('23 March 2020', JLTMA_TD),
				'placeholder'    => __('23 March 2020', JLTMA_TD),
				'label_block'    => true,
		...
		$repeater->add_control(
			...
			[
				...
				'description' => __('Enable linking the whole card. If you have links inside the content of this card, make sure you have this disabled. Links within links are not allowed.', JLTMA_TD),
		...
		$default_title     = '<h2>' . __('Nam commodo suscipit', JLTMA_TD) . '</h2>';
		$default_paragraph = '<p>' . _x('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo', JLTMA_TD) . '</p>';
		...
		$repeater->start_controls_tab('ma_el_custom_timeline_tab_media', ['label' => __('Media', JLTMA_TD)]);

		$repeater->add_control(
			'ma_el_custom_timeline_image',
			[
				'label'   => esc_html__('Choose Image', JLTMA_TD),
				'dynamic' => ['active' => true],
		...
		$repeater->add_group_control(
			...
			[
				...
				'label'   => esc_html__('Image Size', JLTMA_TD),
				'default' => 'large',
		...
		if (ma_el_fs()->can_use_premium_code()) {
			...
			$repeater->start_controls_tab('ma_el_custom_timeline_tab_style', ['label' => __('Style', JLTMA_TD)]);

			$repeater->add_control(
				'ma_el_custom_timeline_custom_style',
				[
					'label'        => __('Custom', JLTMA_TD),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => __('Yes', JLTMA_TD),
					'label_off'    => __('No', JLTMA_TD),
					'return_value' => 'yes',
					'description'  => __('Set custom styles that will only affect this specific item.', JLTMA_TD),
				]
			);
			...
			$repeater->add_control(
				...
				[
					...
					'options' => [
						''        => __('Global', JLTMA_TD),
						'icons'   => __('Icon', JLTMA_TD),
						'image'   => __('Image', JLTMA_TD),
						'numbers' => __('Number', JLTMA_TD),
						'letters' => __('Letter', JLTMA_TD),
					],
					'conditions' => [
						'terms' => [
							[
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Pointer Image', JLTMA_TD),
					'dynamic'   => ['active' => true],
					'type'      => Controls_Manager::MEDIA,
					'condition' => [
			...
			$repeater->add_control(
				...
				[
					'label'      => __('Point Content', JLTMA_TD),
					'type'       => Controls_Manager::TEXT,
					'conditions' => [
						'terms' => [
							[
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Point Background', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '#4b00e7',
					'selectors' => [
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Card Background', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Hovered Point Color', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Hovered Point Background', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} {{CURRENT_ITEM}} .jltma-timeline-post-type-icon:hover,
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Hovered Card Background', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
			...
			$repeater->add_control(
				...
				[
					'label'     => __('Hovered Date Color', JLTMA_TD),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'   => __('Items', JLTMA_TD),
				'type'    => Controls_Manager::REPEATER,
				'default' => [
					[
						'ma_el_custom_timeline_date' => __('February 2, 2014', JLTMA_TD)
					],
					[
						'ma_el_custom_timeline_date' => __('May 10, 2015', JLTMA_TD)
					],
					[
						'ma_el_custom_timeline_date' => __('June 21, 2016', JLTMA_TD)
					],
				],
		...
		*/
		...
		$this->add_responsive_control(
			...
			[
				'label'          => __('Horizontal Align', JLTMA_TD),
				'type'           => Controls_Manager::SELECT,
				'label_block'    => true,
				'default'        => 'center',
				'tablet_default' => 'left',
		...
		$this->add_control(
			...
			[
				'label'        => __('Reverse Cards Positions', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Yes', JLTMA_TD),
				'label_off'    => __('No', JLTMA_TD),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'          => __('Vertical Align', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label'   => __('Horizontal Spacing', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'   => __('Vertical Spacing', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
				],
		...
		*/
		...
		$this->add_control(
			...
			[
				'label'     => __('Excerpt Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		*/
		...
		$this->add_responsive_control(
			'cards_padding',
			[
				'label'      => __('Card Padding', JLTMA_TD),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px'],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'animate_in',
			[
				'label'        => __('Animate Cards', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'animate',
				'label_on'     => __('Yes', JLTMA_TD),
				'label_off'    => __('No', JLTMA_TD),
		...
		$this->start_controls_tab('tab_cards_default', ['label' => __('Default', JLTMA_TD)]);
		...
		$this->start_controls_tab('tab_cards_hover', ['label' => __('Hover', JLTMA_TD)]);
		...
		$this->start_controls_tab('tab_cards_focused', ['label' => __('Focused', JLTMA_TD)]);
		...
		* Timeline Style: Dates
		...
		$this->start_controls_tab('tab_dates_default', ['label' => __('Default', JLTMA_TD)]);
		...
		$this->start_controls_tab('tab_dates_hover', ['label' => __('Hover', JLTMA_TD)]);
		...
		$this->start_controls_tab('tab_dates_focused', ['label' => __('Focused', JLTMA_TD)]);
		...
		* Timeline Style: Line
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'default' => __('Default', JLTMA_TD),
					'icons'   => __('Icons', JLTMA_TD),
					'image'   => __('Image', JLTMA_TD),
					'numbers' => __('Numbers', JLTMA_TD),
					'letters' => __('Letters', JLTMA_TD),
				]
			]
		);
		...
		$this->start_controls_tab('ma_el_timeline_points_default', ['label' => __('Default', JLTMA_TD)]);
		...
		$this->add_responsive_control(
			...
			[
				'label'   => __('Content Size', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
		...
		$this->add_control(
			...
			[
				'label'     => __('Points Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->start_controls_tab('ma_el_timeline_points_hover', ['label' => __('Hover', JLTMA_TD)]);
		...
		$this->start_controls_tab('ma_el_timeline_points_focused', ['label' => __('Focused', JLTMA_TD)]);
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/timeline/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/timeline-element/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=0mcDMKrH1A0" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
		...
		$this->add_render_attribute([
			'ma_el_timeline_wrapper' => [
				'class' =>			[
					...
					'elementor-jltjltmaement-' . esc_attr($unique_id),
					$solid_bg_class
				]
			],
...
<?php
		...
		protected function render_date($echo = true, $post_id = null)
		{
			...
			if ('custom' === $settings['ma_el_timeline_date_source']) {
				$date = isset($loop_settings['ma_el_timeline_date_custom']) ? esc_attr($loop_settings['ma_el_timeline_date_custom']) : '';
			} else {
