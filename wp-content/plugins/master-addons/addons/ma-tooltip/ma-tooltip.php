...
class JLTMA_Tooltip extends Widget_Base
{
	...
	{
		return esc_html__('Tooltip', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Content Settings', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'text' => [
						'title' => esc_html__('Text', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => esc_html__('Hover Me!', JLTMA_TD),
				'condition'   => [
		...
		$this->start_controls_section(
			'tooltip_options',
			[
				'label' => __('Tooltip Options', JLTMA_TD),
			]
		);
		$this->add_control(
			'ma_el_tooltip_text',
			[
				'label'              => esc_html__('Tooltip Text', JLTMA_TD),
				'type'               => Controls_Manager::TEXTAREA,
				'label_block'        => true,
				'default'            => esc_html__('Tooltip contents here.', JLTMA_TD),
				'dynamic'            => ['active' => true],
				'render_type'        => 'none',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Follow Cursor', JLTMA_TD),
				'type'               => Controls_Manager::SWITCHER,
				'render_type'        => 'none',
				'frontend_available' => true
			]
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Trigger on', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					''       => esc_html__('Hover', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Custom Trigger', JLTMA_TD),
		...
		// 	[
		// 		'label' 		=> __('Visible on Hover', JLTMA_TD),
		// 		'type' 			=> Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/tooltip/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/adding-tooltip-in-elementor-editor/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=Av3eTae9vaE" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
...
Customization Options.</span>'
		...
		$this->start_controls_section(
			...
			[
				'label' => __('General Styles', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => __('Content Width', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min'  => 0,
		...
		// Normal State Tab
		$this->start_controls_tab('ma_el_tooltip_content_normal', ['label' => esc_html__('Normal', JLTMA_TD)]);
		$this->add_control(
		...
		// Hover State Tab
		$this->start_controls_tab('ma_el_tooltip_content_hover', ['label' => esc_html__('Hover', JLTMA_TD)]);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Tooltip Styles', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'      => __('Tooltip Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em'],
				'range'      => [
					'px' => [
