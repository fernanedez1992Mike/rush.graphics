...
class JLTMA_Weforms extends Widget_Base
{
	...
	{
		return esc_html__('weForms', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Select weForm', JLTMA_TD)
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Select weForm', JLTMA_TD),
				'description' => esc_html__('Please save and refresh the page after selecting the form', JLTMA_TD),
				'label_block' => true,
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'3'         => __('Style Three', JLTMA_TD),
						'4'         => __('Style Four', JLTMA_TD),
						'wef-pro-1' => __('Style Five (Pro)', JLTMA_TD),
						'wef-pro-2' => __('Style Six (Pro)', JLTMA_TD),
						'wef-pro-3' => __('Style Seven (Pro)', JLTMA_TD),
						'wef-pro-4' => __('Style Eight (Pro)', JLTMA_TD),
						'wef-pro-5' => __('Style Nine (Pro)', JLTMA_TD),
						'wef-pro-6' => __('Style Ten (Pro)', JLTMA_TD),
						'wef-pro-7' => __('Style Eleven (Pro)', JLTMA_TD),
					],
					'description' => sprintf(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Container Styles', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Form Background Color', JLTMA_TD),
		...
		$this->add_responsive_control(
			...
			[
				'label'        => esc_html__('Form Alignment', JLTMA_TD),
				'type'         => Controls_Manager::CHOOSE,
				'label_block'  => true,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Form Max Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'ma_el_weform_margin',
			[
				'label'      => esc_html__('Form Margin', JLTMA_TD),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Fields Styles', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Input Field Background', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Input Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Textarea Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Fields Padding', JLTMA_TD),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-weform-container ul.wpuf-form li .wpuf-fields input[type="text"],
		...
		$this->add_control(
			...
			[
				...
				'label'     => esc_html__('Focus State Style', JLTMA_TD),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Color & Typography', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Field Font Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-weform-container ul.wpuf-form li .wpuf-fields input[type="text"],
					 {{WRAPPER}} .jltma-weform-container ul.wpuf-form li .wpuf-fields input[type="password"],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Placeholder Font Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__('Label Typography', JLTMA_TD),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__('Input Fields Typography', JLTMA_TD),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button Styles', JLTMA_TD),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Button Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range'      => [
					'px' => [
		...
		$this->start_controls_tab('ma_el_weform_submit_btn_hover', ['label' => esc_html__('Hover', JLTMA_TD)]);
...
Customization Options.</span>'
	...
	protected function render()
	{
		...
		if (!class_exists('WeForms')) {
			Master_Addons_Helper::jltma_elementor_plugin_missing_notice(array('plugin_name' => esc_html__('WeForms', JLTMA_TD)));
			return;
		} ?>
