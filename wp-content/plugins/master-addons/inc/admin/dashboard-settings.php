...
class Master_Addons_Admin_Settings
{
	...
	{
		return __('Master Addons', JLTMA_TD);
	}
	...
	public function master_addons_admin_menu()
	{
		...
		$page_title = (isset($jltma_white_label_setting['jltma_wl_plugin_menu_label']) && $jltma_white_label_setting['jltma_wl_plugin_menu_label']) ? $jltma_white_label_setting['jltma_wl_plugin_menu_label'] : __('Master Addons for Elementor', JLTMA_TD);
		$menut_label = (isset($jltma_white_label_setting['jltma_wl_plugin_menu_label']) && $jltma_white_label_setting['jltma_wl_plugin_menu_label']) ? $jltma_white_label_setting['jltma_wl_plugin_menu_label'] : __('Master Addons', JLTMA_TD);
		add_menu_page(
	...
	public function master_addons_el_admin_scripts($hook)
	{
		...
		if ($screen->id == 'toplevel_page_master-addons-settings' || $screen->id == 'toplevel_page_master-addons-settings-network') {
			...
			$jltma_localize_admin_script = array(
				...
				'home_url' => home_url(),
				'rollback' => [
					'rollback_confirm'             => __('Are you sure you want to reinstall version ?', JLTMA_TD),
					'rollback_to_previous_version' => __('Rollback to Previous Version', JLTMA_TD),
					'yes'                          => __('Yes', JLTMA_TD),
					'cancel'                       => __('Cancel', JLTMA_TD),
				]
			);
