    ...
    class Master_Addons_Promotions
    {
        ...
        public function jltma_latest_update_details()
        {
            ...
            $jltma_changelog_message = sprintf(
                __('<h3 class="jltma-update-head">' . JLTMA . ' <span><small><em>v' . JLTMA_VER . '</em></small>' . __(' has some major updates...', JLTMA_TD) . '</span></h3><br>%3$s %4$s %5$s %6$s<br> <strong>Check Changelogs for </strong> <a href="%1$s" target="__blank">%2$s</a>', JLTMA_TD),
                esc_url_raw('https://master-addons.com/changelogs/'),
                __('More Details', JLTMA_TD),

                /** Changelog Items
                 * Starts from: %3$s
                 */
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Template Library not loading issue fixed</span><br>', JLTMA_TD), //%3$s
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Editor icon alignment issue fixed</span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">WordPress 5.9 Compatibility checked </span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Latest Elementor and Elementor Pro version Compatibility checked</span><br>', JLTMA_TD) //%6$s
        ...
        public function jltma_admin_upgrade_pro_notice($notice_key)
        {
            ...
            echo sprintf(
                __(' <p> %1$s <strong>%2$s</strong> %3$s </p> <p><a class="button upgrade-btn mt-4" href="https://master-addons.com/pricing" target="_blank">Upgrade Now</a></p>', JLTMA_TD),
                __("Unlock all possiblities - Ready made Pro Templates, Extensions, Features and much more .. <br>", JLTMA_TD),
                __('20% Discount on all pricing, enjoy the freedom.<br>', JLTMA_TD),
                __("Coupon Code: <strong style='background:yellow; padding:1px 5px; color: #0347FF;'>ENJOY25</strong>", JLTMA_TD)
            );
        ...
        public function jltma_admin_black_friday_cyber_monday_notice($notice_key)
        {
            ...
            echo sprintf(
                __(' <p> %1$s <strong>%2$s</strong> %3$s </p> <p><a class="button upgrade-btn mt-4" href="https://master-addons.com/pricing" target="_blank">Upgrade Now</a></p>', JLTMA_TD),
                __("Unlock all possiblities - 20+ Extensions, Custom Breakpoints, Mega Menu, Icons Library, Comment Form Builder many more.. <br>", JLTMA_TD),
                __('50% Huge Discount for <span style="background:#111; padding:2px 10px; color: #fff;">Black Friday and Cyber Monday Deals</span><br>', JLTMA_TD),
                __("Coupon Code: <strong style='background:yellow; padding:2px 10px; color: #0347FF;'>BLACKFRIDAY50</strong>", JLTMA_TD)
            );
                            ...
                            <ul class="jltma-admin-notice-left-nav column is-2-tablet">
                                ...
                                <li>
                                    <a class="is-flex is-align-items-center" target="_blank" href="https://master-addons.com/all-widgets/">
                                        ...
                                        <?php echo __('All Demos', JLTMA_TD); ?>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="is-flex is-align-items-center" target="_blank" href="https://master-addons.com/contact-us/">
                                        ...
                                        <?php echo __('Contact Us', JLTMA_TD); ?>
                                    </a>
                                </li>
                            </ul>
        ...
        <?php
                        ...
                        public function jltma_admin_notice_styles()
                        {
                            ...
                            jltma_print_unescaped_internal_string('<style>' . $output_css . '</style>');
        ?>
