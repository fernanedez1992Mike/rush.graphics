...
class Master_Addons_Assets
{
    ...
    public function jltma_enqueue_scripts()
    {
        ...
        $jltma_data_table_param = array(
            "lengthMenu"        => esc_html__( 'Display _MENU_ records per page', JLTMA_TD ),
            "zeroRecords"       => esc_html__( 'Nothing found - sorry', JLTMA_TD ),
            "info"              => esc_html__( 'Showing page _PAGE_ of _PAGES_', JLTMA_TD ),
            "infoEmpty"         => esc_html__( 'No records available', JLTMA_TD ),
            "infoFiltered"      => esc_html__( '(filtered from _MAX_ total records)', JLTMA_TD ),
            "searchPlaceholder" => esc_html__( 'Search...', JLTMA_TD ),
            "processing"        => esc_html__( 'Processing...', JLTMA_TD ),
            "csvHtml5"          => esc_html__( 'CSV', JLTMA_TD ),
            "excelHtml5"        => esc_html__( 'Excel', JLTMA_TD ),
            "pdfHtml5"          => esc_html__( 'PDF', JLTMA_TD ),
            "print"             => esc_html__( 'Print', JLTMA_TD ),
        );
