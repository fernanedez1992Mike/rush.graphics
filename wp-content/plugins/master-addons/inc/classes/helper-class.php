...
class Master_Addons_Helper
{
	...
	public static function maad_el_retrive_cf7()
	{
		if (function_exists('wpcf7')) {
			...
			$options = array();
			$options[0] = esc_html__('Select a Form', JLTMA_TD);
			if (!empty($wpcf7_form_list) && !is_wp_error($wpcf7_form_list)) {
				foreach ($wpcf7_form_list as $post) {
					$options[$post->ID] = $post->post_title;
				}
			} else {
				$options[0] = esc_html__('Create a Form First', JLTMA_TD);
			}
			return $options;
		}
	}
		...
		if (class_exists('Ninja_Forms')) {
			...
			if (!empty($contact_forms) && !is_wp_error($contact_forms)) {
				...
				foreach ($contact_forms as $form) {
					if ($i == 0) {
						$options[0] = esc_html__('Select a Contact form', JLTMA_TD);
					}
	...
	public static function ma_el_get_weforms()
	{
		...
		if (!empty($wpuf_form_list) && !is_wp_error($wpuf_form_list)) {
			$options[0] = esc_html__('Select weForm', JLTMA_TD);
	...
	public static function jltma_heading_tags()
	{
		$heading_tags = [
			'h1'  => [
				'title' => __('H1', JLTMA_TD),
				'icon'  => 'eicon-editor-h1'
			],
			'h2'  => [
				'title' => __('H2', JLTMA_TD),
				'icon'  => 'eicon-editor-h2'
			],
			'h3'  => [
				'title' => __('H3', JLTMA_TD),
				'icon'  => 'eicon-editor-h3'
			],
			'h4'  => [
				'title' => __('H4', JLTMA_TD),
				'icon'  => 'eicon-editor-h4'
			],
			'h5'  => [
				'title' => __('H5', JLTMA_TD),
				'icon'  => 'eicon-editor-h5'
			],
			'h6'  => [
				'title' => __('H6', JLTMA_TD),
	...
	{
		$title_tags = [
			'h1'     => esc_html__('H1', JLTMA_TD),
			'h2'     => esc_html__('H2', JLTMA_TD),
			'h3'     => esc_html__('H3', JLTMA_TD),
			'h4'     => esc_html__('H4', JLTMA_TD),
			'h5'     => esc_html__('H5', JLTMA_TD),
			'h6'     => esc_html__('H6', JLTMA_TD),
			'div'    => esc_html__('div', JLTMA_TD),
			'span'   => esc_html__('span', JLTMA_TD),
			'p'      => esc_html__('p', JLTMA_TD),
			'button' => esc_html__('button', JLTMA_TD),
			'a'      => esc_html__('a', JLTMA_TD),
		];
	...
	{
		$position_options = [
			''              => esc_html__('Default', JLTMA_TD),
			'top-left'      => esc_html__('Top Left', JLTMA_TD),
			'top-center'    => esc_html__('Top Center', JLTMA_TD),
			'top-right'     => esc_html__('Top Right', JLTMA_TD),
			'center'        => esc_html__('Center', JLTMA_TD),
			'center-left'   => esc_html__('Center Left', JLTMA_TD),
			'center-right'  => esc_html__('Center Right', JLTMA_TD),
			'bottom-left'   => esc_html__('Bottom Left', JLTMA_TD),
			'bottom-center' => esc_html__('Bottom Center', JLTMA_TD),
			'bottom-right'  => esc_html__('Bottom Right', JLTMA_TD),
		];
	...
	public static function ma_el_transition_options()
	{
		$transition_options = [
			...
			'scale-up'            => __('Scale Up', JLTMA_TD),
			'scale-down'          => __('Scale Down', JLTMA_TD),
			'slide-top'           => __('Slide Top', JLTMA_TD),
			'slide-bottom'        => __('Slide Bottom', JLTMA_TD),
			'slide-left'          => __('Slide Left', JLTMA_TD),
			'slide-right'         => __('Slide Right', JLTMA_TD),
			'slide-top-small'     => __('Slide Top Small', JLTMA_TD),
			'slide-bottom-small'  => __('Slide Bottom Small', JLTMA_TD),
			'slide-left-small'    => __('Slide Left Small', JLTMA_TD),
			'slide-right-small'   => __('Slide Right Small', JLTMA_TD),
			'slide-top-medium'    => __('Slide Top Medium', JLTMA_TD),
			'slide-bottom-medium' => __('Slide Bottom Medium', JLTMA_TD),
			'slide-left-medium'   => __('Slide Left Medium', JLTMA_TD),
			'slide-right-medium'  => __('Slide Right Medium', JLTMA_TD),
		];
	...
	public static function jltma_animation_options()
	{
		$transition_options = [
			...
			'jltma-fade-in'                =>  esc_html__('Fade In', JLTMA_TD),
			'jltma-fade-in-down'           =>  esc_html__('Fade In Down', JLTMA_TD),
			'jltma-fade-in-down-1'         =>  esc_html__('Fade In Down 1', JLTMA_TD),
			'jltma-fade-in-down-2'         =>  esc_html__('Fade In Down 2', JLTMA_TD),
			'jltma-fade-in-up'             =>  esc_html__('Fade In Up', JLTMA_TD),
			'jltma-fade-in-up-1'           =>  esc_html__('Fade In Up 1', JLTMA_TD),
			'jltma-fade-in-up-2'           =>  esc_html__('Fade In Up 2', JLTMA_TD),
			'jltma-fade-in-left'           =>  esc_html__('Fade In Left', JLTMA_TD),
			'jltma-fade-in-left-1'         =>  esc_html__('Fade In Left 1', JLTMA_TD),
			'jltma-fade-in-left-2'         =>  esc_html__('Fade In Left 2', JLTMA_TD),
			'jltma-fade-in-right'          =>  esc_html__('Fade In Right', JLTMA_TD),
			'jltma-fade-in-right-1'        =>  esc_html__('Fade In Right 1', JLTMA_TD),
			'jltma-fade-in-right-2'        =>  esc_html__('Fade In Right 2', JLTMA_TD),

			// Slide Animation
			'jltma-slide-from-right'       =>  esc_html__('Slide From Right', JLTMA_TD),
			'jltma-slide-from-left'        =>  esc_html__('Slide From Left', JLTMA_TD),
			'jltma-slide-from-top'         =>  esc_html__('Slide From Top', JLTMA_TD),
			'jltma-slide-from-bot'         =>  esc_html__('Slide From Bottom', JLTMA_TD),

			// Mask Animation
			'jltma-mask-from-top'          =>  esc_html__('Mask From Top', JLTMA_TD),
			'jltma-mask-from-bot'          =>  esc_html__('Mask From Bottom', JLTMA_TD),
			'jltma-mask-from-left'         =>  esc_html__('Mask From Left', JLTMA_TD),
			'jltma-mask-from-right'        =>  esc_html__('Mask From Right', JLTMA_TD),

			'jltma-rotate-in'              =>  esc_html__('Rotate In', JLTMA_TD),
			'jltma-rotate-in-down-left'    =>  esc_html__('Rotate In Down Left', JLTMA_TD),
			'jltma-rotate-in-down-left-1'  =>  esc_html__('Rotate In Down Left 1', JLTMA_TD),
			'jltma-rotate-in-down-left-2'  =>  esc_html__('Rotate In Down Left 2', JLTMA_TD),
			'jltma-rotate-in-down-right'   =>  esc_html__('Rotate In Down Right', JLTMA_TD),
			'jltma-rotate-in-down-right-1' =>  esc_html__('Rotate In Down Right 1', JLTMA_TD),
			'jltma-rotate-in-down-right-2' =>  esc_html__('Rotate In Down Right 2', JLTMA_TD),
			'jltma-rotate-in-up-left'      =>  esc_html__('Rotate In Up Left', JLTMA_TD),
			'jltma-rotate-in-up-left-1'    =>  esc_html__('Rotate In Up Left 1', JLTMA_TD),
			'jltma-rotate-in-up-left-2'    =>  esc_html__('Rotate In Up Left 2', JLTMA_TD),
			'jltma-rotate-in-up-right'     =>  esc_html__('Rotate In Up Right', JLTMA_TD),
			'jltma-rotate-in-up-right-1'   =>  esc_html__('Rotate In Up Right 1', JLTMA_TD),
			'jltma-rotate-in-up-right-2'   =>  esc_html__('Rotate In Up Right 2', JLTMA_TD),

			'jltma-zoom-in'                =>  esc_html__('Zoom In', JLTMA_TD),
			'jltma-zoom-in-1'              =>  esc_html__('Zoom In 1', JLTMA_TD),
			'jltma-zoom-in-2'              =>  esc_html__('Zoom In 2', JLTMA_TD),
			'jltma-zoom-in-3'              =>  esc_html__('Zoom In 3', JLTMA_TD),

			'jltma-scale-up'               =>  esc_html__('Scale Up', JLTMA_TD),
			'jltma-scale-up-1'             =>  esc_html__('Scale Up 1', JLTMA_TD),
			'jltma-scale-up-2'             =>  esc_html__('Scale Up 2', JLTMA_TD),

			'jltma-scale-down'             =>  esc_html__('Scale Down', JLTMA_TD),
			'jltma-scale-down-1'           =>  esc_html__('Scale Down 1', JLTMA_TD),
			'jltma-scale-down-2'           =>  esc_html__('Scale Down 2', JLTMA_TD),

			'jltma-flip-in-down'           =>  esc_html__('Flip In Down', JLTMA_TD),
			'jltma-flip-in-down-1'         =>  esc_html__('Flip In Down 1', JLTMA_TD),
			'jltma-flip-in-down-2'         =>  esc_html__('Flip In Down 2', JLTMA_TD),
			'jltma-flip-in-up'             =>  esc_html__('Flip In Up', JLTMA_TD),
			'jltma-flip-in-up-1'           =>  esc_html__('Flip In Up 1', JLTMA_TD),
			'jltma-flip-in-up-2'           =>  esc_html__('Flip In Up 2', JLTMA_TD),
			'jltma-flip-in-left'           =>  esc_html__('Flip In Left', JLTMA_TD),
			'jltma-flip-in-left-1'         =>  esc_html__('Flip In Left 1', JLTMA_TD),
			'jltma-flip-in-left-2'         =>  esc_html__('Flip In Left 2', JLTMA_TD),
			'jltma-flip-in-left-3'         =>  esc_html__('Flip In Left 3', JLTMA_TD),
			'jltma-flip-in-right'          =>  esc_html__('Flip In Right', JLTMA_TD),
			'jltma-flip-in-right-1'        =>  esc_html__('Flip In Right 1', JLTMA_TD),
			'jltma-flip-in-right-2'        =>  esc_html__('Flip In Right 2', JLTMA_TD),
			'jltma-flip-in-right-3'        =>  esc_html__('Flip In Right 3', JLTMA_TD),

			'jltma-pulse'                  =>  esc_html__('Pulse In 1', JLTMA_TD),
			'jltma-pulse1'                 =>  esc_html__('Pulse In 2', JLTMA_TD),
			'jltma-pulse2'                 =>  esc_html__('Pulse In 3', JLTMA_TD),
			'jltma-pulse3'                 =>  esc_html__('Pulse In 4', JLTMA_TD),
			'jltma-pulse4'                 =>  esc_html__('Pulse In 5', JLTMA_TD),

			'jltma-pulse-out-1'            =>  esc_html__('Pulse Out 1', JLTMA_TD),
			'jltma-pulse-out-2'            =>  esc_html__('Pulse Out 2', JLTMA_TD),
			'jltma-pulse-out-3'            =>  esc_html__('Pulse Out 3', JLTMA_TD),
			'jltma-pulse-out-4'            =>  esc_html__('Pulse Out 4', JLTMA_TD),

			// Specials
			'jltma-shake'                  =>  esc_html__('Shake', JLTMA_TD),
			'jltma-bounce-in'              =>  esc_html__('Bounce In', JLTMA_TD),
			'jltma-jack-in-box'            =>  esc_html__('Jack In the Box', JLTMA_TD)
		];
	...
	public static function jltma_custom_message($title, $content)
	{
		...
		<div class="elementor-alert elementor-alert-danger" role="alert">
			<span class="elementor-alert-title">
				<?php echo sprintf(esc_html__('%s !', JLTMA_TD), $title); ?>
			</span>
			<span class="elementor-alert-description">
				<?php echo sprintf(esc_html__('%s ', JLTMA_TD), $content); ?>
			</span>
		</div>

	<?php
		$notice =  ob_get_clean();
		jltma_print_unescaped_internal_string($notice);
	}
	...
	?>
		<div class="elementor-alert elementor-alert-danger" role="alert">
			<span class="elementor-alert-title">
				<?php echo sprintf(esc_html__('"%s" Plugin is Not Activated!', JLTMA_TD), esc_html($args['plugin_name'])); ?>
			</span>
			<span class="elementor-alert-description">
				<?php esc_html_e(
	...
	public static function jltma_elements_lite_get_fluent_forms()
	{
		...
		if (function_exists('wpFluentForm')) {
			...
			if ($result) {
				...
				$options[0] = esc_html__('No forms found!', JLTMA_TD);
			}
		}
			...
			<div class="jltma-tooltip-item tooltip-top">
				...
				<div class="jltma-tooltip-text">
					<a href="<?php echo esc_url($info_url); ?>" class="jltma-tooltip-content" target="_blank">
						<?php echo sprintf(esc_html__('%s', JLTMA_TD), $info_name); ?>
					</a>
				</div>
			</div>
<?php }
	...
	public static function get_taxonomies_options()
	{
		...
		if (empty($taxonomies)) {
			$options[''] = __('No taxonomies found', JLTMA_TD);
			return $options;
		}
	...
	public static function jltma_post_types_category_slug()
	{
		...
		$post_types = [
			'category' => esc_html__('Post', JLTMA_TD)
		];

		if (class_exists('WooCommerce')) {
			$post_types['product_cat'] = esc_html__('Product', JLTMA_TD);
		}
	...
	public static function jltma_get_page_title($include_context = true)
	{
		...
		if (is_singular()) {
			...
			/* translators: %s: Search term. */
			$title = sprintf(__('Search Results for: %s', JLTMA_TD), get_search_query());

			if (get_query_var('paged')) {
				/* translators: %s is the page number. */
				$title .= sprintf(__('&nbsp;&ndash; Page %s', JLTMA_TD), get_query_var('paged'));
			}
		} elseif (is_category()) {
			...
			if ($include_context) {
				...
				$title = sprintf(__('Category: %s', JLTMA_TD), $title);
			}
		} elseif (is_tag()) {
			$title = single_tag_title('', false);
			if ($include_context) {
				/* translators: Tag archive title. 1: Tag name */
				$title = sprintf(__('Tag: %s', JLTMA_TD), $title);
			}
		} elseif (is_author()) {
			...
			if ($include_context) {
				...
				$title = sprintf(__('Author: %s', JLTMA_TD), $title);
			}
		} elseif (is_year()) {
			$title = get_the_date(_x('Y', 'yearly archives date format', JLTMA_TD));

			if ($include_context) {
				/* translators: Yearly archive title. 1: Year */
				$title = sprintf(__('Year: %s', JLTMA_TD), $title);
			}
		} elseif (is_month()) {
			$title = get_the_date(_x('F Y', 'monthly archives date format', JLTMA_TD));

			if ($include_context) {
				/* translators: Monthly archive title. 1: Month name and year */
				$title = sprintf(__('Month: %s', JLTMA_TD), $title);
			}
		} elseif (is_day()) {
			$title = get_the_date(_x('F j, Y', 'daily archives date format', JLTMA_TD));

			if ($include_context) {
				/* translators: Daily archive title. 1: Date */
				$title = sprintf(__('Day: %s', JLTMA_TD), $title);
			}
		} elseif (is_tax('post_format')) {
			if (is_tax('post_format', 'post-format-aside')) {
				$title = _x('Asides', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-gallery')) {
				$title = _x('Galleries', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-image')) {
				$title = _x('Images', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-video')) {
				$title = _x('Videos', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-quote')) {
				$title = _x('Quotes', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-link')) {
				$title = _x('Links', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-status')) {
				$title = _x('Statuses', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-audio')) {
				$title = _x('Audio', 'post format archive title', JLTMA_TD);
			} elseif (is_tax('post_format', 'post-format-chat')) {
				$title = _x('Chats', 'post format archive title', JLTMA_TD);
			}
			...
			if ($include_context) {
				...
				$title = sprintf(__('Archives: %s', JLTMA_TD), $title);
			}
		} elseif (is_tax()) {
			...
			if ($include_context) {
				...
				$title = sprintf(__('%1$s: %2$s', JLTMA_TD), $tax->labels->singular_name, $title);
			}
		} elseif (is_404()) {
			$title = __('Page Not Found', JLTMA_TD);
		} // End if().
	...
	{
		$position_options = [
			'no'                   => esc_html__('Blank', JLTMA_TD),
			'yes'                  => esc_html__('Blurred placeholder image', JLTMA_TD),
			'progress-box'         => esc_html__('In-progress box animation', JLTMA_TD),
			'simple-spinner'       => esc_html__('Loading spinner (blue)', JLTMA_TD),
			'simple-spinner-light' => esc_html__('Loading spinner (light)', JLTMA_TD),
			'simple-spinner-dark'  => esc_html__('Loading spinner (dark)', JLTMA_TD)
		];
		return $position_options;
	}
	...
	public static function jltma_pro_locked_html()
	{
		return '<div class="elementor-nerd-box">
			...
			__('Oups, hang on!', JLTMA_TD) .
			'</div>
			<div class="elementor-nerd-box-message">' .
			__('This feature is only available if you have Master Addons Pro.', JLTMA_TD) .
			'</div>
	...
	{
		return [
			'' => esc_html__('Top (Default)', JLTMA_TD),
			...
			'auto'       => esc_html__('Auto', JLTMA_TD),
			'auto-start' => esc_html__('Auto Start', JLTMA_TD),
			'auto-end'   => esc_html__('Auto End', JLTMA_TD),
		];
	}
		...
		if ($source == 'wp_posts') {
			...
			if ($categories) {
				foreach ($categories as $category) {
					$output .= '<a href="' . get_category_link($category->term_id) . '" title="' . esc_attr(sprintf(__("View all posts in %s", JLTMA_TD), $category->name)) . '" ' . $css_link . '>' . esc_html($category->cat_name) . '</a>' . esc_html($separator);
					if ($count == $limit) {
						break;
					}
					$count++;
			...
			if ($term_list) {
				foreach ($term_list as $tax_term) {
					$output .= '<a href="' . esc_attr(get_term_link($tax_term, $posts_type)) . '" title="' . esc_attr(sprintf(__("View all posts in %s", JLTMA_TD), $tax_term->name)) . '" ' . $css_link . '>' . esc_html($tax_term->name) . '</a>' . esc_html($separator);
				}
			}
		}
