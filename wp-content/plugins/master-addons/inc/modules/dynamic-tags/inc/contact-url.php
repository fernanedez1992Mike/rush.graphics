...
class JLTMA_Contact_URL extends Tag
{
	...
	{
		return esc_html__('Contact URL', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => '— ' . esc_html__('Select', JLTMA_TD) . ' —',
					'email' => esc_html__('Email', JLTMA_TD),
					'tel' => esc_html__('Tel', JLTMA_TD),
					'sms' => esc_html__('SMS', JLTMA_TD),
					'whatsapp' => esc_html__('WhatsApp', JLTMA_TD),
					'skype' => esc_html__('Skype', JLTMA_TD),
					'messenger' => esc_html__('Messenger', JLTMA_TD),
					'viber' => esc_html__('Viber', JLTMA_TD),
					'waze' => esc_html__('Waze', JLTMA_TD),
					'google_calendar' => esc_html__('Google Calendar', JLTMA_TD),
					'outlook_calendar' => esc_html__('Outlook Calendar', JLTMA_TD),
					'yahoo_calendar' => esc_html__('Yahoo Calendar', JLTMA_TD),
				],
			]
		);
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => esc_html__('Subject', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'mail_body',
			[
				'label' => esc_html__('Message', JLTMA_TD),
		...
		$this->add_control(
			'username',
			[
				'label' => esc_html__('Username', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'viber_action',
			[
				'label' => esc_html__('Action', JLTMA_TD),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => esc_html__('Contact', JLTMA_TD),
					'add' => esc_html__('Add', JLTMA_TD),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => esc_html__('Call', JLTMA_TD),
					'chat' => esc_html__('Chat', JLTMA_TD),
					'userinfo' => esc_html__('Show Profile', JLTMA_TD),
					'add' => esc_html__('Add to Contacts', JLTMA_TD),
					'voicemail' => esc_html__('Send Voice Mail', JLTMA_TD),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => esc_html__('Location', JLTMA_TD),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => esc_html__('Start', JLTMA_TD),
