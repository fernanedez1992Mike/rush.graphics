    ...
    if (('section' === $element->get_name() && 'section_background' === $section_id) || ('column' === $element->get_name() && 'section_style' === $section_id)) {
      ...
      $element->start_controls_section(
        ...
        [
          ...
          'label' => JLTMA_BADGE . __(' Particles', JLTMA_TD)
        ]
      );
      ...
      $element->add_control(
        ...
        [
          ...
          'label' => __('Enable Particle Background', JLTMA_TD),
          'default' => '',
      ...
      $element->add_control(
        ...
        [
          ...
          'raw' => __('<a href="https://vincentgarreau.com/particles.js/" target="_blank">Click here</a> to generate JSON for the below field. </br><a href="https://master-addons.com/add-particles-background-in-elementor-section/" target="_blank">Know more</a> about using this feature.', JLTMA_TD),
          'separator' => 'none',
          'condition' => [
            'ma_el_enable_particles' => 'yes',
          ],
      ...
      $element->add_control(
        ...
        [
          ...
          'label'   => __('Add Particle Json', JLTMA_TD),
          'default' => '{
                                  "particles": {
                                    "number": {
                                      "value": 80,
...
?>
  ...
  public function after_render($element)
  {
    ...
    ?>
      <style>
        .elementor-element-<?php echo $element->get_id(); ?>.jltma-particle-wrapper>canvas {
