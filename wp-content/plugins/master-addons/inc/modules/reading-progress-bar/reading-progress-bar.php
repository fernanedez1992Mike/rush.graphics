...
class JLTMA_Extension_Reading_Progress_Bar
{
	...
	public function jltma_rpb_register_controls($element)
	{
		...
		$element->start_controls_section(
			...
			[
				...
				'label' 		=> JLTMA_BADGE . esc_html__(' Reading Progress Bar', JLTMA_TD)
			]
		);
		...
		$element->add_control(
			...
			[
				...
				'label' 		=> esc_html__('Enable Reading Progress Bar', JLTMA_TD),
				'default' 		=> '',
		...
		$element->add_control(
			...
			[
				'label' => esc_html__('Fill Color', JLTMA_TD),
				'type' => Controls_Manager::COLOR,
				'default' => '#007bff',
				'selectors' => [
		...
		$element->add_control(
			...
			[
				'label' => esc_html__('Animation Speed', JLTMA_TD),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
	...
	public function jltma_reading_progress_bar_styles()
	{
		...
		if (did_action('elementor/loaded')) {
			...
			jltma_print_unescaped_internal_string('<style>' . $jltma_r_p_b_custom_css . '</style>');
		}
	}
	...
	public function jltma_reading_progress_bar_render()
	{
		...
		$document = Master_Addons_Helper::jltma_elementor()->documents->get(get_the_ID());
		...
		if (did_action('elementor/loaded')) {
			...
			$jltma_reading_progress_bar_html = '<div class="ma-el-page-scroll-indicator ' . esc_attr($jltma_scroll_pos) . '">
