...
Best Elementor Addons for speed up Design Creativity. Mega Menu, Custom Breakpoints, Header Footer & Comment Form Builder, Custom CSS, Custom JS, dynamic conditions etc.
...
>[All Addons](https://master-addons.com/all-widgets/) | [Support](https://master-addons.com/support/) | [Docs](https://master-addons.com/docs/) | [Tutorials](https://www.youtube.com/watch?v=rdrqWa-tf6Q&list=PLqpMw0NsHXV9V6UwRniXTUkabCJtOhyIf) | [Upgrade Pro](https://master-addons.com/go/upgrade-pro/)

> Includes 70+ Addons, 20+ Extensions & 1000+ Sections
>
> 50% Discount for Black Friday and Cyber Monday, Coupon Code: BLACKFRIDAY50  [Purchase Now](https://master-addons.com/go/upgrade-pro/)
...
***Currently we have 45+ elements and 20+ extensions that can help you build a prettier website.***
...
29. [Nav Menu](https://master-addons.com/demos/nav-menu/)
...
14. [Domain Checker](https://master-addons.com/demos/domain-search/)
15. [Toggle Content](https://master-addons.com/demos/toggle-content/)
16. [Gallery Slider](https://master-addons.com/demos/gallery-slider/)
17. [Offcanvas Menu] ()

== Form Elements ==
1. [Contact Forms 7](https://master-addons.com/demos/contact-form-design/)
2. [Ninja Forms](https://master-addons.com/demos/contact-form-design/)
3. [WP Forms](https://master-addons.com/demos/contact-form-design/)
4. [Caldera Forms](https://master-addons.com/demos/contact-form-design/)
5. [weForms](https://master-addons.com/demos/contact-form-design/)
6. [Gravity Forms (Pro Element)](https://master-addons.com/demos/contact-form-design/)
...
45. Floating Effects: Imagine having a wide variety of floating effects on your webpage. That's exactly what Master Addons can do for you. Add some transform, scale, skew property for animation. This floating elementor effects will work in a infinite loop. Just wisely define your animation value and update your page.

46. Dynamic Tags: If you are planning to create a dynamic page for your visitors then you must try dynamic tags. Master Addons developed some awesome tags that will help you to target different properties easily.

47. Wrapper Link: You can set a link to any element, section, or column using this extension. Sometimes it's necessary to input a link in an entire section or column, by default there is no such way. This problem can be solved with Master Addons wrapper link extension.

48. Container Extras: Define exact width, height, for your section or column using Master Addons Container Extras extension. You can select the value in px, em, percentage, and VW.

49. Display Conditions: Block or Showcase any content of your webpage for a specific audience. For example, you can showcase "login button" for non-logged-in visitors and when someone logged in, they will see the "account button". There are a lot of conditions available inside this extension. Just select your desired conditions and update your page.

50. Tooltips Extension: We have an element for Tooltips but now it's available as an extension too. Now you can set tooltip content to any elements, sections, or column from the advanced option.
