...
// Heros
class Pixercontentwithimage_widgets extends Widget_Base {
 
   public function get_name() {
      return 'Pixercontentwithimage';
   }
 
   public function get_title() {
      return esc_html__( 'Content with Image', 'pixer-for-elementor' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'image_section',
         [
            'label' => esc_html__( 'Content With Image', 'pixer-for-elementor' ),
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __('Market strategy','pixer-for-elementor')
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __('Build your Digital Marketplace for Sell Downloads','pixer-for-elementor')
         ]
      );
      ...
      $this->add_control(
         'image',
         [
            'label' => __( 'Image', 'pixer-for-elementor' ),
