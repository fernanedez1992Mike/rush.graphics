...
// Heros
class Pixerbanner2_widgets extends Widget_Base {
 
   public function get_name() {
      return 'Pixerbannertwo';
   }
 
   public function get_title() {
      return esc_html__( 'Banner Two', 'pixer-for-elementor' );
   }
   ...
   protected function render( $instance = [] ) {
      ...
      <!-- banner-area -->
          <section class="banner-area2 s-banner-bg slider-area fix p-relative">
